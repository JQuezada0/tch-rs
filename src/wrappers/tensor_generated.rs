...
#![allow(clippy::all)]
use crate::{Device, Kind, Scalar, Tensor, Layout};
...
impl Tensor {
    ...
    pub fn internal_lshift_scalar_out_<S: Into<Scalar>>(
        &self, out: &Tensor, other: S
    ) -> Tensor {
        self.f_internal_lshift_scalar_out_(out, other).unwrap()
    }

    pub fn internal_lshift_tensor_(
        &mut self, other: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_lshift_tensor_out_(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
        self.f_internal_lshift_tensor_out_(out, other).unwrap()
    }

    pub fn internal_or_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
        self.f_internal_or_(other).unwrap()
    }

    pub fn internal_or_tensor_(
        &mut self, other: &Tensor
    ) -> Tensor {
        self.f_internal_or_tensor_(other).unwrap()
    }

    pub fn internal_rshift_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn internal_rshift_tensor_(
        &mut self, other: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_xor_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
        self.f_internal_xor_(other).unwrap()
    }

    pub fn internal_xor_tensor_(
        &mut self, other: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_add_batch_dim(
        &self, batch_dim: i64, level: i64
    ) -> Tensor {
        self.f_internal_add_batch_dim(batch_dim, level).unwrap()
    }

    pub fn internal_add_relu(
        &self, other: &Tensor
    ) -> Tensor {
        self.f_internal_add_relu(other).unwrap()
    }

    pub fn internal_add_relu_(
        &mut self, other: &Tensor
    ) -> Tensor {
        self.f_internal_add_relu_(other).unwrap()
    }

    pub fn internal_add_relu_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
        self.f_internal_add_relu_out(out, other).unwrap()
    }

    pub fn internal_add_relu_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
    ...
    pub fn internal_aminmax_dim_out(
        &self, out0: &Tensor, out1: &Tensor, dim: i64, keepdim: bool
    ) -> (Tensor, Tensor) {
        self.f_internal_aminmax_dim_out(out0, out1, dim, keepdim).unwrap()
    }

    pub fn internal_aminmax_out(
        &self, out0: &Tensor, out1: &Tensor
    ) -> (Tensor, Tensor) {
        self.f_internal_aminmax_out(out0, out1).unwrap()
    }

    pub fn internal_amp_update_scale(
        &self, growth_tracker: &Tensor, found_inf: &Tensor, scale_growth_factor: f64, scale_backoff_factor: f64, growth_interval: i64
    ) -> (Tensor, Tensor) {
        self.f_internal_amp_update_scale(growth_tracker, found_inf, scale_growth_factor, scale_backoff_factor, growth_interval).unwrap()
    }

    pub fn internal_amp_update_scale_(
        &mut self, growth_tracker: &Tensor, found_inf: &Tensor, scale_growth_factor: f64, scale_backoff_factor: f64, growth_interval: i64
    ) -> Tensor {
        self.f_internal_amp_update_scale_(growth_tracker, found_inf, scale_growth_factor, scale_backoff_factor, growth_interval).unwrap()
    }

    pub fn internal_amp_update_scale_out(
        &self, out: &Tensor, growth_tracker: &Tensor, found_inf: &Tensor, scale_growth_factor: f64, scale_backoff_factor: f64, growth_interval: i64
    ) -> Tensor {
        self.f_internal_amp_update_scale_out(out, growth_tracker, found_inf, scale_growth_factor, scale_backoff_factor, growth_interval).unwrap()
    }

    pub fn internal_assert_tensor_metadata(
        a: &Tensor, size: impl IntListOption, stride: impl IntListOption, dtype: impl Into<Option<Kind>>
    ) {
    ...
    pub fn internal_autocast_to_reduced_precision(
        &self, cuda_enabled: bool, cpu_enabled: bool, cuda_dtype: Kind, cpu_dtype: Kind
    ) -> Tensor {
        self.f_internal_autocast_to_reduced_precision(cuda_enabled, cpu_enabled, cuda_dtype, cpu_dtype).unwrap()
    }

    pub fn internal_cast_byte(
        &self, non_blocking: bool
    ) -> Tensor {
        self.f_internal_cast_byte(non_blocking).unwrap()
    }

    pub fn internal_cast_char(
        &self, non_blocking: bool
    ) -> Tensor {
        self.f_internal_cast_char(non_blocking).unwrap()
    }

    pub fn internal_cast_double(
        &self, non_blocking: bool
    ) -> Tensor {
        self.f_internal_cast_double(non_blocking).unwrap()
    }

    pub fn internal_cast_float(
        &self, non_blocking: bool
    ) -> Tensor {
        self.f_internal_cast_float(non_blocking).unwrap()
    }

    pub fn internal_cast_half(
        &self, non_blocking: bool
    ) -> Tensor {
        self.f_internal_cast_half(non_blocking).unwrap()
    }

    pub fn internal_cast_int(
        &self, non_blocking: bool
    ) -> Tensor {
        self.f_internal_cast_int(non_blocking).unwrap()
    }

    pub fn internal_cast_long(
        &self, non_blocking: bool
    ) -> Tensor {
        self.f_internal_cast_long(non_blocking).unwrap()
    }

    pub fn internal_cast_short(
        &self, non_blocking: bool
    ) -> Tensor {
    ...
    pub fn internal_conv_depthwise2d<T: Borrow<Tensor>>(
        &self, weight: &Tensor, kernel_size: impl IntList, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList
    ) -> Tensor {
        self.f_internal_conv_depthwise2d(weight, kernel_size, bias, stride, padding, dilation).unwrap()
    }

    pub fn internal_conv_depthwise2d_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, kernel_size: impl IntList, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList
    ) -> Tensor {
        self.f_internal_conv_depthwise2d_out(out, weight, kernel_size, bias, stride, padding, dilation).unwrap()
    }

    pub fn internal_convert_indices_from_coo_to_csr(
        &self, size: i64, out_int32: bool
    ) -> Tensor {
        self.f_internal_convert_indices_from_coo_to_csr(size, out_int32).unwrap()
    }

    pub fn internal_convert_indices_from_coo_to_csr_out(
        &self, out: &Tensor, size: i64, out_int32: bool
    ) -> Tensor {
    ...
    pub fn internal_convert_indices_from_csr_to_coo(
        crow_indices: &Tensor, col_indices: &Tensor, out_int32: bool, transpose: bool
    ) -> Tensor {
        Tensor::f_internal_convert_indices_from_csr_to_coo(crow_indices, col_indices, out_int32, transpose).unwrap()
    }

    pub fn internal_convert_indices_from_csr_to_coo_out(
        out: &Tensor, crow_indices: &Tensor, col_indices: &Tensor, out_int32: bool, transpose: bool
    ) -> Tensor {
        Tensor::f_internal_convert_indices_from_csr_to_coo_out(out, crow_indices, col_indices, out_int32, transpose).unwrap()
    }

    pub fn internal_convert_weight_to_int4pack(
        &self, innerktiles: i64
    ) -> Tensor {
        self.f_internal_convert_weight_to_int4pack(innerktiles).unwrap()
    }

    pub fn internal_convolution<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList, transposed: bool, output_padding: impl IntList, groups: i64, benchmark: bool, deterministic: bool, cudnn_enabled: bool, allow_tf32: bool
    ) -> Tensor {
        self.f_internal_convolution(weight, bias, stride, padding, dilation, transposed, output_padding, groups, benchmark, deterministic, cudnn_enabled, allow_tf32).unwrap()
    }

    pub fn internal_convolution_deprecated<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList, transposed: bool, output_padding: impl IntList, groups: i64, benchmark: bool, deterministic: bool, cudnn_enabled: bool
    ) -> Tensor {
        self.f_internal_convolution_deprecated(weight, bias, stride, padding, dilation, transposed, output_padding, groups, benchmark, deterministic, cudnn_enabled).unwrap()
    }

    pub fn internal_convolution_mode<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, stride: impl IntList, padding: &str, dilation: impl IntList, groups: i64
    ) -> Tensor {
    ...
    pub fn internal_convolution_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList, transposed: bool, output_padding: impl IntList, groups: i64, benchmark: bool, deterministic: bool, cudnn_enabled: bool, allow_tf32: bool
    ) -> Tensor {
        self.f_internal_convolution_out(out, weight, bias, stride, padding, dilation, transposed, output_padding, groups, benchmark, deterministic, cudnn_enabled, allow_tf32).unwrap()
    }

    pub fn internal_copy_from(
        &self, dst: &Tensor, non_blocking: bool
    ) -> Tensor {
        self.f_internal_copy_from(dst, non_blocking).unwrap()
    }

    pub fn internal_copy_from_and_resize(
        &self, dst: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_cslt_sparse_mm<T: Borrow<Tensor>>(
        compressed_a: &Tensor, dense_b: &Tensor, bias: Option<T>, alpha: Option<T>, out_dtype: impl Into<Option<Kind>>, transpose_result: bool, alg_id: i64
    ) -> Tensor {
        Tensor::f_internal_cslt_sparse_mm(compressed_a, dense_b, bias, alpha, out_dtype, transpose_result, alg_id).unwrap()
    }

    pub fn internal_cslt_sparse_mm_search<T: Borrow<Tensor>>(
        compressed_a: &Tensor, dense_b: &Tensor, bias: Option<T>, alpha: Option<T>, out_dtype: impl Into<Option<Kind>>, transpose_result: bool
    ) -> i64 {
        Tensor::f_internal_cslt_sparse_mm_search(compressed_a, dense_b, bias, alpha, out_dtype, transpose_result).unwrap()
    }

    pub fn internal_ctc_loss(
        log_probs: &Tensor, targets: &Tensor, input_lengths: impl IntList, target_lengths: impl IntList, blank: i64, zero_infinity: bool
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_ctc_loss(log_probs, targets, input_lengths, target_lengths, blank, zero_infinity).unwrap()
    }

    pub fn internal_ctc_loss_backward(
        grad: &Tensor, log_probs: &Tensor, targets: &Tensor, input_lengths: impl IntList, target_lengths: impl IntList, neg_log_likelihood: &Tensor, log_alpha: &Tensor, blank: i64, zero_infinity: bool
    ) -> Tensor {
        Tensor::f_internal_ctc_loss_backward(grad, log_probs, targets, input_lengths, target_lengths, neg_log_likelihood, log_alpha, blank, zero_infinity).unwrap()
    }

    pub fn internal_ctc_loss_backward_out(
        out: &Tensor, grad: &Tensor, log_probs: &Tensor, targets: &Tensor, input_lengths: impl IntList, target_lengths: impl IntList, neg_log_likelihood: &Tensor, log_alpha: &Tensor, blank: i64, zero_infinity: bool
    ) -> Tensor {
        Tensor::f_internal_ctc_loss_backward_out(out, grad, log_probs, targets, input_lengths, target_lengths, neg_log_likelihood, log_alpha, blank, zero_infinity).unwrap()
    }

    pub fn internal_ctc_loss_backward_tensor(
        grad: &Tensor, log_probs: &Tensor, targets: &Tensor, input_lengths: &Tensor, target_lengths: &Tensor, neg_log_likelihood: &Tensor, log_alpha: &Tensor, blank: i64, zero_infinity: bool
    ) -> Tensor {
        Tensor::f_internal_ctc_loss_backward_tensor(grad, log_probs, targets, input_lengths, target_lengths, neg_log_likelihood, log_alpha, blank, zero_infinity).unwrap()
    }

    pub fn internal_ctc_loss_out(
        out0: &Tensor, out1: &Tensor, log_probs: &Tensor, targets: &Tensor, input_lengths: impl IntList, target_lengths: impl IntList, blank: i64, zero_infinity: bool
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_ctc_loss_out(out0, out1, log_probs, targets, input_lengths, target_lengths, blank, zero_infinity).unwrap()
    }
    ...
    pub fn internal_ctc_loss_tensor(
        ...
        Tensor::f_internal_ctc_loss_tensor(log_probs, targets, input_lengths, target_lengths, blank, zero_infinity).unwrap()
    }
    ...
    pub fn internal_ctc_loss_tensor_out(
        ...
        Tensor::f_internal_ctc_loss_tensor_out(out0, out1, log_probs, targets, input_lengths, target_lengths, blank, zero_infinity).unwrap()
    }

    pub fn internal_cudnn_ctc_loss(
        log_probs: &Tensor, targets: &Tensor, input_lengths: impl IntList, target_lengths: impl IntList, blank: i64, deterministic: bool, zero_infinity: bool
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_cudnn_ctc_loss(log_probs, targets, input_lengths, target_lengths, blank, deterministic, zero_infinity).unwrap()
    }

    pub fn internal_cudnn_ctc_loss_out(
        out0: &Tensor, out1: &Tensor, log_probs: &Tensor, targets: &Tensor, input_lengths: impl IntList, target_lengths: impl IntList, blank: i64, deterministic: bool, zero_infinity: bool
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_cudnn_ctc_loss_out(out0, out1, log_probs, targets, input_lengths, target_lengths, blank, deterministic, zero_infinity).unwrap()
    }
    ...
    pub fn internal_cudnn_ctc_loss_tensor(
        ...
        Tensor::f_internal_cudnn_ctc_loss_tensor(log_probs, targets, input_lengths, target_lengths, blank, deterministic, zero_infinity).unwrap()
    }

    pub fn internal_cudnn_init_dropout_state(
        dropout: f64, train: bool, dropout_seed: i64, options: (Kind, Device)
    ) -> Tensor {
    ...
    pub fn internal_cudnn_init_dropout_state_out(
        out: &Tensor, dropout: f64, train: bool, dropout_seed: i64
    ) -> Tensor {
    ...
    pub fn internal_cudnn_rnn<T: Borrow<Tensor>>(
        &self, weight: &[T], weight_stride0: i64, weight_buf: Option<T>, hx: &Tensor, cx: Option<T>, mode: i64, hidden_size: i64, proj_size: i64, num_layers: i64, batch_first: bool, dropout: f64, train: bool, bidirectional: bool, batch_sizes: impl IntList, dropout_state: Option<T>
    ) -> (Tensor, Tensor, Tensor, Tensor, Tensor) {
        self.f_internal_cudnn_rnn(weight, weight_stride0, weight_buf, hx, cx, mode, hidden_size, proj_size, num_layers, batch_first, dropout, train, bidirectional, batch_sizes, dropout_state).unwrap()
    }

    pub fn internal_cudnn_rnn_flatten_weight<T: Borrow<Tensor>>(
        weight_arr: &[T], weight_stride0: i64, input_size: i64, mode: i64, hidden_size: i64, proj_size: i64, num_layers: i64, batch_first: bool, bidirectional: bool
    ) -> Tensor {
        Tensor::f_internal_cudnn_rnn_flatten_weight(weight_arr, weight_stride0, input_size, mode, hidden_size, proj_size, num_layers, batch_first, bidirectional).unwrap()
    }

    pub fn internal_cudnn_rnn_flatten_weight_out<T: Borrow<Tensor>>(
        out: &Tensor, weight_arr: &[T], weight_stride0: i64, input_size: i64, mode: i64, hidden_size: i64, proj_size: i64, num_layers: i64, batch_first: bool, bidirectional: bool
    ) -> Tensor {
        Tensor::f_internal_cudnn_rnn_flatten_weight_out(out, weight_arr, weight_stride0, input_size, mode, hidden_size, proj_size, num_layers, batch_first, bidirectional).unwrap()
    }

    pub fn internal_cudnn_rnn_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, out3: &Tensor, out4: &Tensor, weight: &[T], weight_stride0: i64, weight_buf: Option<T>, hx: &Tensor, cx: Option<T>, mode: i64, hidden_size: i64, proj_size: i64, num_layers: i64, batch_first: bool, dropout: f64, train: bool, bidirectional: bool, batch_sizes: impl IntList, dropout_state: Option<T>
    ) -> (Tensor, Tensor, Tensor, Tensor, Tensor) {
        self.f_internal_cudnn_rnn_out(out0, out1, out2, out3, out4, weight, weight_stride0, weight_buf, hx, cx, mode, hidden_size, proj_size, num_layers, batch_first, dropout, train, bidirectional, batch_sizes, dropout_state).unwrap()
    }

    pub fn internal_debug_has_internal_overlap(
        &self, 
    ) -> i64 {
        self.f_internal_debug_has_internal_overlap().unwrap()
    }

    pub fn internal_dim_arange(
        like: &Tensor, dim: i64
    ) -> Tensor {
        Tensor::f_internal_dim_arange(like, dim).unwrap()
    }

    pub fn internal_dimi(
        &self, 
    ) -> i64 {
        self.f_internal_dimi().unwrap()
    }

    pub fn internal_dimv(
        &self, 
    ) -> i64 {
    ...
    pub fn internal_efficient_attention_backward<T: Borrow<Tensor>>(
        grad_out_: &Tensor, query: &Tensor, key: &Tensor, value: &Tensor, bias: Option<T>, out: &Tensor, cu_seqlens_q: Option<T>, cu_seqlens_k: Option<T>, max_seqlen_q: i64, max_seqlen_k: i64, logsumexp: &Tensor, dropout_p: f64, philox_seed: &Tensor, philox_offset: &Tensor, custom_mask_type: i64, bias_requires_grad: bool, scale: impl Into<Option<f64>>, num_splits_key: impl Into<Option<i64>>
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        Tensor::f_internal_efficient_attention_backward(grad_out_, query, key, value, bias, out, cu_seqlens_q, cu_seqlens_k, max_seqlen_q, max_seqlen_k, logsumexp, dropout_p, philox_seed, philox_offset, custom_mask_type, bias_requires_grad, scale, num_splits_key).unwrap()
    }

    pub fn internal_efficientzerotensor(
        size: impl IntList, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_internal_efficientzerotensor(size, options).unwrap()
    }

    pub fn internal_efficientzerotensor_out(
        out: &Tensor, size: impl IntList
    ) -> Tensor {
        Tensor::f_internal_efficientzerotensor_out(out, size).unwrap()
    }

    pub fn internal_embedding_bag<T: Borrow<Tensor>>(
        weight: &Tensor, indices: &Tensor, offsets: &Tensor, scale_grad_by_freq: bool, mode: i64, sparse: bool, per_sample_weights: Option<T>, include_last_offset: bool, padding_idx: i64
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        Tensor::f_internal_embedding_bag(weight, indices, offsets, scale_grad_by_freq, mode, sparse, per_sample_weights, include_last_offset, padding_idx).unwrap()
    }

    pub fn internal_embedding_bag_backward<T: Borrow<Tensor>>(
        grad: &Tensor, indices: &Tensor, offsets: &Tensor, offset2bag: &Tensor, bag_size: &Tensor, maximum_indices: &Tensor, num_weights: i64, scale_grad_by_freq: bool, mode: i64, sparse: bool, per_sample_weights: Option<T>, padding_idx: i64
    ) -> Tensor {
        Tensor::f_internal_embedding_bag_backward(grad, indices, offsets, offset2bag, bag_size, maximum_indices, num_weights, scale_grad_by_freq, mode, sparse, per_sample_weights, padding_idx).unwrap()
    }

    pub fn internal_embedding_bag_dense_backward<T: Borrow<Tensor>>(
        grad: &Tensor, indices: &Tensor, offset2bag: &Tensor, bag_size: &Tensor, maximum_indices: &Tensor, num_weights: i64, scale_grad_by_freq: bool, mode: i64, per_sample_weights: Option<T>, padding_idx: i64
    ) -> Tensor {
        Tensor::f_internal_embedding_bag_dense_backward(grad, indices, offset2bag, bag_size, maximum_indices, num_weights, scale_grad_by_freq, mode, per_sample_weights, padding_idx).unwrap()
    }

    pub fn internal_embedding_bag_dense_backward_out<T: Borrow<Tensor>>(
        out: &Tensor, grad: &Tensor, indices: &Tensor, offset2bag: &Tensor, bag_size: &Tensor, maximum_indices: &Tensor, num_weights: i64, scale_grad_by_freq: bool, mode: i64, per_sample_weights: Option<T>, padding_idx: i64
    ) -> Tensor {
        Tensor::f_internal_embedding_bag_dense_backward_out(out, grad, indices, offset2bag, bag_size, maximum_indices, num_weights, scale_grad_by_freq, mode, per_sample_weights, padding_idx).unwrap()
    }

    pub fn internal_embedding_bag_forward_only<T: Borrow<Tensor>>(
        weight: &Tensor, indices: &Tensor, offsets: &Tensor, scale_grad_by_freq: bool, mode: i64, sparse: bool, per_sample_weights: Option<T>, include_last_offset: bool, padding_idx: i64
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        Tensor::f_internal_embedding_bag_forward_only(weight, indices, offsets, scale_grad_by_freq, mode, sparse, per_sample_weights, include_last_offset, padding_idx).unwrap()
    }

    pub fn internal_embedding_bag_forward_only_out<T: Borrow<Tensor>>(
        out0: &Tensor, out1: &Tensor, out2: &Tensor, out3: &Tensor, weight: &Tensor, indices: &Tensor, offsets: &Tensor, scale_grad_by_freq: bool, mode: i64, sparse: bool, per_sample_weights: Option<T>, include_last_offset: bool, padding_idx: i64
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        Tensor::f_internal_embedding_bag_forward_only_out(out0, out1, out2, out3, weight, indices, offsets, scale_grad_by_freq, mode, sparse, per_sample_weights, include_last_offset, padding_idx).unwrap()
    }

    pub fn internal_embedding_bag_out<T: Borrow<Tensor>>(
        out0: &Tensor, out1: &Tensor, out2: &Tensor, out3: &Tensor, weight: &Tensor, indices: &Tensor, offsets: &Tensor, scale_grad_by_freq: bool, mode: i64, sparse: bool, per_sample_weights: Option<T>, include_last_offset: bool, padding_idx: i64
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        Tensor::f_internal_embedding_bag_out(out0, out1, out2, out3, weight, indices, offsets, scale_grad_by_freq, mode, sparse, per_sample_weights, include_last_offset, padding_idx).unwrap()
    }

    pub fn internal_embedding_bag_per_sample_weights_backward(
        grad: &Tensor, weight: &Tensor, indices: &Tensor, offsets: &Tensor, offset2bag: &Tensor, mode: i64, padding_idx: i64
    ) -> Tensor {
        Tensor::f_internal_embedding_bag_per_sample_weights_backward(grad, weight, indices, offsets, offset2bag, mode, padding_idx).unwrap()
    }

    pub fn internal_embedding_bag_per_sample_weights_backward_out(
        out: &Tensor, grad: &Tensor, weight: &Tensor, indices: &Tensor, offsets: &Tensor, offset2bag: &Tensor, mode: i64, padding_idx: i64
    ) -> Tensor {
        Tensor::f_internal_embedding_bag_per_sample_weights_backward_out(out, grad, weight, indices, offsets, offset2bag, mode, padding_idx).unwrap()
    }

    pub fn internal_embedding_bag_sparse_backward<T: Borrow<Tensor>>(
        grad: &Tensor, indices: &Tensor, offsets: &Tensor, offset2bag: &Tensor, bag_size: &Tensor, num_weights: i64, scale_grad_by_freq: bool, mode: i64, per_sample_weights: Option<T>, padding_idx: i64
    ) -> Tensor {
        Tensor::f_internal_embedding_bag_sparse_backward(grad, indices, offsets, offset2bag, bag_size, num_weights, scale_grad_by_freq, mode, per_sample_weights, padding_idx).unwrap()
    }

    pub fn internal_empty_affine_quantized(
        size: impl IntList, options: (Kind, Device), scale: f64, zero_point: i64
    ) -> Tensor {
        Tensor::f_internal_empty_affine_quantized(size, options, scale, zero_point).unwrap()
    }

    pub fn internal_empty_affine_quantized_out(
        out: &Tensor, size: impl IntList, scale: f64, zero_point: i64
    ) -> Tensor {
    ...
    pub fn internal_empty_per_channel_affine_quantized(
        size: impl IntList, scales: &Tensor, zero_points: &Tensor, axis: i64, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_internal_empty_per_channel_affine_quantized(size, scales, zero_points, axis, options).unwrap()
    }

    pub fn internal_empty_per_channel_affine_quantized_out(
        out: &Tensor, size: impl IntList, scales: &Tensor, zero_points: &Tensor, axis: i64
    ) -> Tensor {
        Tensor::f_internal_empty_per_channel_affine_quantized_out(out, size, scales, zero_points, axis).unwrap()
    }

    pub fn internal_euclidean_dist(
        x1: &Tensor, x2: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_fake_quantize_learnable_per_channel_affine(
        &self, scale: &Tensor, zero_point: &Tensor, axis: i64, quant_min: i64, quant_max: i64, grad_factor: f64
    ) -> Tensor {
        self.f_internal_fake_quantize_learnable_per_channel_affine(scale, zero_point, axis, quant_min, quant_max, grad_factor).unwrap()
    }

    pub fn internal_fake_quantize_learnable_per_channel_affine_backward(
        &self, grad: &Tensor, scale: &Tensor, zero_point: &Tensor, axis: i64, quant_min: i64, quant_max: i64, grad_factor: f64
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_fake_quantize_learnable_per_channel_affine_backward(grad, scale, zero_point, axis, quant_min, quant_max, grad_factor).unwrap()
    }

    pub fn internal_fake_quantize_learnable_per_channel_affine_out(
        &self, out: &Tensor, scale: &Tensor, zero_point: &Tensor, axis: i64, quant_min: i64, quant_max: i64, grad_factor: f64
    ) -> Tensor {
        self.f_internal_fake_quantize_learnable_per_channel_affine_out(out, scale, zero_point, axis, quant_min, quant_max, grad_factor).unwrap()
    }

    pub fn internal_fake_quantize_learnable_per_tensor_affine(
        &self, scale: &Tensor, zero_point: &Tensor, quant_min: i64, quant_max: i64, grad_factor: f64
    ) -> Tensor {
        self.f_internal_fake_quantize_learnable_per_tensor_affine(scale, zero_point, quant_min, quant_max, grad_factor).unwrap()
    }

    pub fn internal_fake_quantize_learnable_per_tensor_affine_backward(
        &self, grad: &Tensor, scale: &Tensor, zero_point: &Tensor, quant_min: i64, quant_max: i64, grad_factor: f64
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_fake_quantize_learnable_per_tensor_affine_backward(grad, scale, zero_point, quant_min, quant_max, grad_factor).unwrap()
    }

    pub fn internal_fake_quantize_learnable_per_tensor_affine_out(
        &self, out: &Tensor, scale: &Tensor, zero_point: &Tensor, quant_min: i64, quant_max: i64, grad_factor: f64
    ) -> Tensor {
        self.f_internal_fake_quantize_learnable_per_tensor_affine_out(out, scale, zero_point, quant_min, quant_max, grad_factor).unwrap()
    }

    pub fn internal_fake_quantize_per_tensor_affine_cachemask_tensor_qparams(
        &self, scale: &Tensor, zero_point: &Tensor, fake_quant_enabled: &Tensor, quant_min: i64, quant_max: i64
    ) -> (Tensor, Tensor) {
        self.f_internal_fake_quantize_per_tensor_affine_cachemask_tensor_qparams(scale, zero_point, fake_quant_enabled, quant_min, quant_max).unwrap()
    }

    pub fn internal_fake_quantize_per_tensor_affine_cachemask_tensor_qparams_out(
        &self, out0: &Tensor, out1: &Tensor, scale: &Tensor, zero_point: &Tensor, fake_quant_enabled: &Tensor, quant_min: i64, quant_max: i64
    ) -> (Tensor, Tensor) {
        self.f_internal_fake_quantize_per_tensor_affine_cachemask_tensor_qparams_out(out0, out1, scale, zero_point, fake_quant_enabled, quant_min, quant_max).unwrap()
    }

    pub fn internal_fft_c2c(
        &self, dim: impl IntList, normalization: i64, forward: bool
    ) -> Tensor {
        self.f_internal_fft_c2c(dim, normalization, forward).unwrap()
    }

    pub fn internal_fft_c2c_out(
        &self, out: &Tensor, dim: impl IntList, normalization: i64, forward: bool
    ) -> Tensor {
        self.f_internal_fft_c2c_out(out, dim, normalization, forward).unwrap()
    }

    pub fn internal_fft_c2r(
        &self, dim: impl IntList, normalization: i64, last_dim_size: i64
    ) -> Tensor {
        self.f_internal_fft_c2r(dim, normalization, last_dim_size).unwrap()
    }

    pub fn internal_fft_c2r_out(
        &self, out: &Tensor, dim: impl IntList, normalization: i64, last_dim_size: i64
    ) -> Tensor {
        self.f_internal_fft_c2r_out(out, dim, normalization, last_dim_size).unwrap()
    }

    pub fn internal_fft_r2c(
        &self, dim: impl IntList, normalization: i64, onesided: bool
    ) -> Tensor {
        self.f_internal_fft_r2c(dim, normalization, onesided).unwrap()
    }

    pub fn internal_fft_r2c_out(
        &self, out: &Tensor, dim: impl IntList, normalization: i64, onesided: bool
    ) -> Tensor {
        self.f_internal_fft_r2c_out(out, dim, normalization, onesided).unwrap()
    }

    pub fn internal_fill_mem_eff_dropout_mask_(
        &mut self, dropout_p: f64, seed: i64, offset: i64
    ) -> Tensor {
        self.f_internal_fill_mem_eff_dropout_mask_(dropout_p, seed, offset).unwrap()
    }

    pub fn internal_flash_attention_backward(
        grad_out: &Tensor, query: &Tensor, key: &Tensor, value: &Tensor, out: &Tensor, logsumexp: &Tensor, cum_seq_q: &Tensor, cum_seq_k: &Tensor, max_q: i64, max_k: i64, dropout_p: f64, is_causal: bool, philox_seed: &Tensor, philox_offset: &Tensor, scale: impl Into<Option<f64>>
    ) -> (Tensor, Tensor, Tensor) {
        Tensor::f_internal_flash_attention_backward(grad_out, query, key, value, out, logsumexp, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, philox_seed, philox_offset, scale).unwrap()
    }

    pub fn internal_foobar(
        &self, arg1: bool, arg2: bool, arg3: bool
    ) -> Tensor {
        self.f_internal_foobar(arg1, arg2, arg3).unwrap()
    }

    pub fn internal_foobar_out(
        &self, out: &Tensor, arg1: bool, arg2: bool, arg3: bool
    ) -> Tensor {
        self.f_internal_foobar_out(out, arg1, arg2, arg3).unwrap()
    }

    pub fn internal_functional_assert_async(
        &self, assert_msg: &str, dep_token: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_functional_sym_constrain_range<S: Into<Scalar>>(
        size: S, min: impl Into<Option<i64>>, max: impl Into<Option<i64>>, dep_token: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_functional_sym_constrain_range_for_size<S: Into<Scalar>>(
        ...
        Tensor::f_internal_functional_sym_constrain_range_for_size(size, min, max, dep_token).unwrap()
    }

    pub fn internal_fused_dropout(
        &self, p: f64
    ) -> (Tensor, Tensor) {
    ...
    pub fn internal_fused_dropout_out(
        &self, out0: &Tensor, out1: &Tensor, p: f64
    ) -> (Tensor, Tensor) {
        self.f_internal_fused_dropout_out(out0, out1, p).unwrap()
    }

    pub fn internal_fused_moving_avg_obs_fq_helper(
        &self, observer_on: &Tensor, fake_quant_on: &Tensor, running_min: &Tensor, running_max: &Tensor, scale: &Tensor, zero_point: &Tensor, averaging_const: f64, quant_min: i64, quant_max: i64, ch_axis: i64, per_row_fake_quant: bool, symmetric_quant: bool
    ) -> (Tensor, Tensor) {
        self.f_internal_fused_moving_avg_obs_fq_helper(observer_on, fake_quant_on, running_min, running_max, scale, zero_point, averaging_const, quant_min, quant_max, ch_axis, per_row_fake_quant, symmetric_quant).unwrap()
    }

    pub fn internal_fused_moving_avg_obs_fq_helper_functional(
        &self, observer_on: &Tensor, fake_quant_on: &Tensor, running_min: &Tensor, running_max: &Tensor, scale: &Tensor, zero_point: &Tensor, averaging_const: f64, quant_min: i64, quant_max: i64, ch_axis: i64, per_row_fake_quant: bool, symmetric_quant: bool
    ) -> (Tensor, Tensor, Tensor, Tensor, Tensor, Tensor) {
        self.f_internal_fused_moving_avg_obs_fq_helper_functional(observer_on, fake_quant_on, running_min, running_max, scale, zero_point, averaging_const, quant_min, quant_max, ch_axis, per_row_fake_quant, symmetric_quant).unwrap()
    }

    pub fn internal_fused_moving_avg_obs_fq_helper_out(
        &self, out0: &Tensor, out1: &Tensor, observer_on: &Tensor, fake_quant_on: &Tensor, running_min: &Tensor, running_max: &Tensor, scale: &Tensor, zero_point: &Tensor, averaging_const: f64, quant_min: i64, quant_max: i64, ch_axis: i64, per_row_fake_quant: bool, symmetric_quant: bool
    ) -> (Tensor, Tensor) {
        self.f_internal_fused_moving_avg_obs_fq_helper_out(out0, out1, observer_on, fake_quant_on, running_min, running_max, scale, zero_point, averaging_const, quant_min, quant_max, ch_axis, per_row_fake_quant, symmetric_quant).unwrap()
    }

    pub fn internal_fused_sdp_choice<T: Borrow<Tensor>>(
        query: &Tensor, key: &Tensor, value: &Tensor, attn_mask: Option<T>, dropout_p: f64, is_causal: bool, scale: impl Into<Option<f64>>
    ) -> i64 {
        Tensor::f_internal_fused_sdp_choice(query, key, value, attn_mask, dropout_p, is_causal, scale).unwrap()
    }

    pub fn internal_fw_primal(
        &self, level: i64
    ) -> Tensor {
        self.f_internal_fw_primal(level).unwrap()
    }

    pub fn internal_fw_primal_copy(
        &self, level: i64
    ) -> Tensor {
    ...
    pub fn internal_fw_primal_copy_out(
        &self, out: &Tensor, level: i64
    ) -> Tensor {
        self.f_internal_fw_primal_copy_out(out, level).unwrap()
    }

    pub fn internal_gather_sparse_backward(
        &self, dim: i64, index: &Tensor, grad: &Tensor
    ) -> Tensor {
        self.f_internal_gather_sparse_backward(dim, index, grad).unwrap()
    }

    pub fn internal_grid_sampler_2d_cpu_fallback(
        &self, grid: &Tensor, interpolation_mode: i64, padding_mode: i64, align_corners: bool
    ) -> Tensor {
        self.f_internal_grid_sampler_2d_cpu_fallback(grid, interpolation_mode, padding_mode, align_corners).unwrap()
    }

    pub fn internal_grid_sampler_2d_cpu_fallback_backward(
        &self, grad_output: &Tensor, grid: &Tensor, interpolation_mode: i64, padding_mode: i64, align_corners: bool
    ) -> (Tensor, Tensor) {
        self.f_internal_grid_sampler_2d_cpu_fallback_backward(grad_output, grid, interpolation_mode, padding_mode, align_corners).unwrap()
    }

    pub fn internal_grid_sampler_2d_cpu_fallback_out(
        &self, out: &Tensor, grid: &Tensor, interpolation_mode: i64, padding_mode: i64, align_corners: bool
    ) -> Tensor {
        self.f_internal_grid_sampler_2d_cpu_fallback_out(out, grid, interpolation_mode, padding_mode, align_corners).unwrap()
    }
    ...
    pub fn internal_has_same_storage_numel(
        &self, other: &Tensor
    ) -> bool {
    ...
    pub fn internal_histogramdd_bin_edges<T: Borrow<Tensor>>(
        &self, bins: impl IntList, range: impl DoubleList, weight: Option<T>, density: bool
    ) -> Vec<Tensor> {
    ...
    pub fn internal_histogramdd_bin_edges_out<T: Borrow<Tensor>>(
        &self, out: &[T], bins: impl IntList, range: impl DoubleList, weight: Option<T>, density: bool
    ) {
    ...
    pub fn internal_histogramdd_from_bin_cts_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, bins: impl IntList, range: impl DoubleList, weight: Option<T>, density: bool
    ) -> Tensor {
    ...
    pub fn internal_histogramdd_from_bin_tensors<T: Borrow<Tensor>>(
        &self, bins: &[T], weight: Option<T>, density: bool
    ) -> Tensor {
    ...
    pub fn internal_histogramdd_from_bin_tensors_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, bins: &[T], weight: Option<T>, density: bool
    ) -> Tensor {
    ...
    pub fn internal_index_put_impl<T: Borrow<Tensor>>(
        &self, indices: &[Option<T>], values: &Tensor, accumulate: bool, unsafe_: bool
    ) -> Tensor {
        self.f_internal_index_put_impl(indices, values, accumulate, unsafe_).unwrap()
    }

    pub fn internal_index_put_impl_<T: Borrow<Tensor>>(
        &mut self, indices: &[Option<T>], values: &Tensor, accumulate: bool, unsafe_: bool
    ) -> Tensor {
    ...
    pub fn internal_linalg_eigh_eigenvalues(
        eigenvalues: &Tensor, eigenvectors: &Tensor, a: &Tensor, uplo: &str, compute_v: bool
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_linalg_eigh_eigenvalues(eigenvalues, eigenvectors, a, uplo, compute_v).unwrap()
    }
    ...
    pub fn internal_linalg_slogdet_sign(
        sign: &Tensor, logabsdet: &Tensor, lu: &Tensor, pivots: &Tensor, a: &Tensor
    ) -> (Tensor, Tensor, Tensor, Tensor) {
    ...
    pub fn internal_linalg_solve_ex_result(
        ...
        Tensor::f_internal_linalg_solve_ex_result(result, lu, pivots, info, a, b, left, check_errors).unwrap()
    }

    pub fn internal_linalg_svd(
        a: &Tensor, full_matrices: bool, compute_uv: bool, driver: &str
    ) -> (Tensor, Tensor, Tensor) {
        Tensor::f_internal_linalg_svd(a, full_matrices, compute_uv, driver).unwrap()
    }

    pub fn internal_linalg_svd_u(
        u: &Tensor, s: &Tensor, vh: &Tensor, a: &Tensor, full_matrices: bool, compute_uv: bool, driver: &str
    ) -> (Tensor, Tensor, Tensor) {
        Tensor::f_internal_linalg_svd_u(u, s, vh, a, full_matrices, compute_uv, driver).unwrap()
    }

    pub fn internal_log_softmax(
        &self, dim: i64, half_to_float: bool
    ) -> Tensor {
        self.f_internal_log_softmax(dim, half_to_float).unwrap()
    }

    pub fn internal_log_softmax_backward_data(
        grad_output: &Tensor, output: &Tensor, dim: i64, input_dtype: Kind
    ) -> Tensor {
    ...
    pub fn internal_log_softmax_backward_data_out(
        out: &Tensor, grad_output: &Tensor, output: &Tensor, dim: i64, input_dtype: Kind
    ) -> Tensor {
        Tensor::f_internal_log_softmax_backward_data_out(out, grad_output, output, dim, input_dtype).unwrap()
    }

    pub fn internal_log_softmax_out(
        &self, out: &Tensor, dim: i64, half_to_float: bool
    ) -> Tensor {
        self.f_internal_log_softmax_out(out, dim, half_to_float).unwrap()
    }

    pub fn internal_logcumsumexp(
        &self, dim: i64
    ) -> Tensor {
        self.f_internal_logcumsumexp(dim).unwrap()
    }

    pub fn internal_logcumsumexp_out(
        &self, out: &Tensor, dim: i64
    ) -> Tensor {
    ...
    pub fn internal_lstm_mps<T: Borrow<Tensor>>(
        ...
        self.f_internal_lstm_mps(hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first).unwrap()
    }

    pub fn internal_lstm_mps_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, out3: &Tensor, out4: &Tensor, out5: &Tensor, hx: &[T], params: &[T], has_biases: bool, num_layers: i64, dropout: f64, train: bool, bidirectional: bool, batch_first: bool
    ) -> (Tensor, Tensor, Tensor, Tensor, Tensor, Tensor) {
        self.f_internal_lstm_mps_out(out0, out1, out2, out3, out4, out5, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first).unwrap()
    }

    pub fn internal_lu_with_info(
        &self, pivot: bool, check_errors: bool
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_lu_with_info(pivot, check_errors).unwrap()
    }

    pub fn internal_make_dep_token(
        options: (Kind, Device)
    ) -> Tensor {
    ...
    pub fn internal_make_per_channel_quantized_tensor(
        &self, scale: &Tensor, zero_point: &Tensor, axis: i64
    ) -> Tensor {
    ...
    pub fn internal_make_per_channel_quantized_tensor_out(
        &self, out: &Tensor, scale: &Tensor, zero_point: &Tensor, axis: i64
    ) -> Tensor {
    ...
    pub fn internal_mps_convolution_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, bias: Option<T>, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64
    ) -> Tensor {
        self.f_internal_mps_convolution_out(out, weight, bias, padding, stride, dilation, groups).unwrap()
    }

    pub fn internal_mps_convolution_transpose(
        &self, weight: &Tensor, padding: impl IntList, output_padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64
    ) -> Tensor {
        self.f_internal_mps_convolution_transpose(weight, padding, output_padding, stride, dilation, groups).unwrap()
    }

    pub fn internal_mps_convolution_transpose_out(
        &self, out: &Tensor, weight: &Tensor, padding: impl IntList, output_padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64
    ) -> Tensor {
        self.f_internal_mps_convolution_transpose_out(out, weight, padding, output_padding, stride, dilation, groups).unwrap()
    }

    pub fn internal_native_batch_norm_legit<T: Borrow<Tensor>>(
        &self, weight: Option<T>, bias: Option<T>, running_mean: &Tensor, running_var: &Tensor, training: bool, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_native_batch_norm_legit(weight, bias, running_mean, running_var, training, momentum, eps).unwrap()
    }

    pub fn internal_native_batch_norm_legit_functional<T: Borrow<Tensor>>(
        &self, weight: Option<T>, bias: Option<T>, running_mean: &Tensor, running_var: &Tensor, training: bool, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor, Tensor, Tensor) {
        self.f_internal_native_batch_norm_legit_functional(weight, bias, running_mean, running_var, training, momentum, eps).unwrap()
    }

    pub fn internal_native_batch_norm_legit_no_stats<T: Borrow<Tensor>>(
        &self, weight: Option<T>, bias: Option<T>, training: bool, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_native_batch_norm_legit_no_stats(weight, bias, training, momentum, eps).unwrap()
    }

    pub fn internal_native_batch_norm_legit_no_stats_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, save_mean: &Tensor, save_invstd: &Tensor, weight: Option<T>, bias: Option<T>, training: bool, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_native_batch_norm_legit_no_stats_out(out, save_mean, save_invstd, weight, bias, training, momentum, eps).unwrap()
    }

    pub fn internal_native_batch_norm_legit_no_training<T: Borrow<Tensor>>(
        &self, weight: Option<T>, bias: Option<T>, running_mean: &Tensor, running_var: &Tensor, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_native_batch_norm_legit_no_training(weight, bias, running_mean, running_var, momentum, eps).unwrap()
    }

    pub fn internal_native_batch_norm_legit_no_training_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, weight: Option<T>, bias: Option<T>, running_mean: &Tensor, running_var: &Tensor, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_native_batch_norm_legit_no_training_out(out0, out1, out2, weight, bias, running_mean, running_var, momentum, eps).unwrap()
    }

    pub fn internal_native_batch_norm_legit_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, save_mean: &Tensor, save_invstd: &Tensor, weight: Option<T>, bias: Option<T>, running_mean: &Tensor, running_var: &Tensor, training: bool, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_native_batch_norm_legit_out(out, save_mean, save_invstd, weight, bias, running_mean, running_var, training, momentum, eps).unwrap()
    }

    pub fn internal_native_multi_head_attention<T: Borrow<Tensor>>(
        query: &Tensor, key: &Tensor, value: &Tensor, embed_dim: i64, num_head: i64, qkv_weight: &Tensor, qkv_bias: &Tensor, proj_weight: &Tensor, proj_bias: &Tensor, mask: Option<T>, need_weights: bool, average_attn_weights: bool, mask_type: impl Into<Option<i64>>
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_native_multi_head_attention(query, key, value, embed_dim, num_head, qkv_weight, qkv_bias, proj_weight, proj_bias, mask, need_weights, average_attn_weights, mask_type).unwrap()
    }

    pub fn internal_native_multi_head_attention_out<T: Borrow<Tensor>>(
        out0: &Tensor, out1: &Tensor, query: &Tensor, key: &Tensor, value: &Tensor, embed_dim: i64, num_head: i64, qkv_weight: &Tensor, qkv_bias: &Tensor, proj_weight: &Tensor, proj_bias: &Tensor, mask: Option<T>, need_weights: bool, average_attn_weights: bool, mask_type: impl Into<Option<i64>>
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_native_multi_head_attention_out(out0, out1, query, key, value, embed_dim, num_head, qkv_weight, qkv_bias, proj_weight, proj_bias, mask, need_weights, average_attn_weights, mask_type).unwrap()
    }

    pub fn internal_neg_view(
        &self, 
    ) -> Tensor {
        self.f_internal_neg_view().unwrap()
    }

    pub fn internal_neg_view_copy(
        &self, 
    ) -> Tensor {
        self.f_internal_neg_view_copy().unwrap()
    }

    pub fn internal_neg_view_copy_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_nested_from_padded(
        ...
        Tensor::f_internal_nested_from_padded(padded, cpu_nested_shape_example, fuse_transform_0213).unwrap()
    }
    ...
    pub fn internal_nested_view_from_buffer_copy_out(
        &self, out: &Tensor, nested_size: &Tensor, nested_strides: &Tensor, offsets: &Tensor
    ) -> Tensor {
        self.f_internal_nested_view_from_buffer_copy_out(out, nested_size, nested_strides, offsets).unwrap()
    }

    pub fn internal_new_zeros_with_same_feature_meta(
        &self, other: &Tensor, self_num_batch_dims: i64
    ) -> Tensor {
    ...
    pub fn internal_new_zeros_with_same_feature_meta_out(
        &self, out: &Tensor, other: &Tensor, self_num_batch_dims: i64
    ) -> Tensor {
        self.f_internal_new_zeros_with_same_feature_meta_out(out, other, self_num_batch_dims).unwrap()
    }

    pub fn internal_nnpack_available(
    ...
    pub fn internal_nnpack_spatial_convolution<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, padding: impl IntList, stride: impl IntList
    ) -> Tensor {
    ...
    pub fn internal_nnpack_spatial_convolution_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, bias: Option<T>, padding: impl IntList, stride: impl IntList
    ) -> Tensor {
    ...
    pub fn internal_pack_padded_sequence(
        &self, lengths: &Tensor, batch_first: bool
    ) -> (Tensor, Tensor) {
        self.f_internal_pack_padded_sequence(lengths, batch_first).unwrap()
    }

    pub fn internal_pack_padded_sequence_backward(
        grad: &Tensor, input_size: impl IntList, batch_sizes: &Tensor, batch_first: bool
    ) -> Tensor {
        Tensor::f_internal_pack_padded_sequence_backward(grad, input_size, batch_sizes, batch_first).unwrap()
    }

    pub fn internal_pack_padded_sequence_out(
        &self, out0: &Tensor, out1: &Tensor, lengths: &Tensor, batch_first: bool
    ) -> (Tensor, Tensor) {
        self.f_internal_pack_padded_sequence_out(out0, out1, lengths, batch_first).unwrap()
    }

    pub fn internal_pad_circular(
        &self, pad: impl IntList
    ) -> Tensor {
        self.f_internal_pad_circular(pad).unwrap()
    }

    pub fn internal_pad_enum(
        &self, pad: impl IntList, mode: i64, value: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_internal_pad_enum(pad, mode, value).unwrap()
    }

    pub fn internal_pad_packed_sequence<S: Into<Scalar>>(
        data: &Tensor, batch_sizes: &Tensor, batch_first: bool, padding_value: S, total_length: i64
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_pad_packed_sequence(data, batch_sizes, batch_first, padding_value, total_length).unwrap()
    }

    pub fn internal_pdist_backward(
        &self, grad: &Tensor, p: f64, pdist: &Tensor
    ) -> Tensor {
        self.f_internal_pdist_backward(grad, p, pdist).unwrap()
    }

    pub fn internal_pdist_backward_out(
        &self, out: &Tensor, grad: &Tensor, p: f64, pdist: &Tensor
    ) -> Tensor {
        self.f_internal_pdist_backward_out(out, grad, p, pdist).unwrap()
    }

    pub fn internal_pin_memory(
        &self, device: Device
    ) -> Tensor {
    ...
    pub fn internal_pin_memory_out(
        &self, out: &Tensor, device: Device
    ) -> Tensor {
        self.f_internal_pin_memory_out(out, device).unwrap()
    }

    pub fn internal_prelu_kernel(
        &self, weight: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_propagate_xla_data(
        &self, output: &Tensor
    ) {
    ...
    pub fn internal_reshape_alias_copy_out(
        &self, out: &Tensor, size: impl IntList, stride: impl IntList
    ) -> Tensor {
        self.f_internal_reshape_alias_copy_out(out, size, stride).unwrap()
    }

    pub fn internal_reshape_copy(
        &self, size: impl IntList
    ) -> Tensor {
        self.f_internal_reshape_copy(size).unwrap()
    }

    pub fn internal_reshape_from_tensor(
        &self, shape: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_sample_dirichlet(
        &self, 
    ) -> Tensor {
        self.f_internal_sample_dirichlet().unwrap()
    }

    pub fn internal_sample_dirichlet_out(
        &self, out: &Tensor
    ) -> Tensor {
        self.f_internal_sample_dirichlet_out(out).unwrap()
    }

    pub fn internal_saturate_weight_to_fp16(
        weight: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_scaled_dot_product_attention_math<T: Borrow<Tensor>>(
        query: &Tensor, key: &Tensor, value: &Tensor, attn_mask: Option<T>, dropout_p: f64, is_causal: bool, dropout_mask: Option<T>, scale: impl Into<Option<f64>>
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_scaled_dot_product_attention_math(query, key, value, attn_mask, dropout_p, is_causal, dropout_mask, scale).unwrap()
    }

    pub fn internal_scaled_dot_product_efficient_attention<T: Borrow<Tensor>>(
        query: &Tensor, key: &Tensor, value: &Tensor, attn_bias: Option<T>, compute_log_sumexp: bool, dropout_p: f64, is_causal: bool, scale: impl Into<Option<f64>>
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        Tensor::f_internal_scaled_dot_product_efficient_attention(query, key, value, attn_bias, compute_log_sumexp, dropout_p, is_causal, scale).unwrap()
    }

    pub fn internal_scaled_dot_product_flash_attention_backward(
        grad_out: &Tensor, query: &Tensor, key: &Tensor, value: &Tensor, out: &Tensor, logsumexp: &Tensor, cum_seq_q: &Tensor, cum_seq_k: &Tensor, max_q: i64, max_k: i64, dropout_p: f64, is_causal: bool, philox_seed: &Tensor, philox_offset: &Tensor, scale: impl Into<Option<f64>>
    ) -> (Tensor, Tensor, Tensor) {
        Tensor::f_internal_scaled_dot_product_flash_attention_backward(grad_out, query, key, value, out, logsumexp, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, philox_seed, philox_offset, scale).unwrap()
    }

    pub fn internal_scaled_mm<T: Borrow<Tensor>>(
        &self, mat2: &Tensor, bias: Option<T>, out_dtype: impl Into<Option<Kind>>, scale_a: Option<T>, scale_b: Option<T>, scale_result: Option<T>, use_fast_accum: bool
    ) -> (Tensor, Tensor) {
        self.f_internal_scaled_mm(mat2, bias, out_dtype, scale_a, scale_b, scale_result, use_fast_accum).unwrap()
    }

    pub fn internal_scaled_mm_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, out_amax: &Tensor, mat2: &Tensor, bias: Option<T>, out_dtype: impl Into<Option<Kind>>, scale_a: Option<T>, scale_b: Option<T>, scale_result: Option<T>, use_fast_accum: bool
    ) -> (Tensor, Tensor) {
        self.f_internal_scaled_mm_out(out, out_amax, mat2, bias, out_dtype, scale_a, scale_b, scale_result, use_fast_accum).unwrap()
    }

    pub fn internal_scatter_reduce(
        &self, dim: i64, index: &Tensor, src: &Tensor, reduce: &str, include_self: bool
    ) -> Tensor {
        self.f_internal_scatter_reduce(dim, index, src, reduce, include_self).unwrap()
    }

    pub fn internal_scatter_reduce_(
        &mut self, dim: i64, index: &Tensor, src: &Tensor, reduce: &str, include_self: bool
    ) -> Tensor {
        self.f_internal_scatter_reduce_(dim, index, src, reduce, include_self).unwrap()
    }

    pub fn internal_scatter_reduce_two_out(
        &self, out: &Tensor, dim: i64, index: &Tensor, src: &Tensor, reduce: &str, include_self: bool
    ) -> Tensor {
    ...
    pub fn internal_segment_reduce_backward<T: Borrow<Tensor>, S: Into<Scalar>>(
        grad: &Tensor, output: &Tensor, data: &Tensor, reduce: &str, lengths: Option<T>, offsets: Option<T>, axis: i64, initial: S
    ) -> Tensor {
        Tensor::f_internal_segment_reduce_backward(grad, output, data, reduce, lengths, offsets, axis, initial).unwrap()
    }

    pub fn internal_segment_reduce_backward_out<T: Borrow<Tensor>, S: Into<Scalar>>(
        out: &Tensor, grad: &Tensor, output: &Tensor, data: &Tensor, reduce: &str, lengths: Option<T>, offsets: Option<T>, axis: i64, initial: S
    ) -> Tensor {
        Tensor::f_internal_segment_reduce_backward_out(out, grad, output, data, reduce, lengths, offsets, axis, initial).unwrap()
    }

    pub fn internal_shape_as_tensor(
        &self, 
    ) -> Tensor {
    ...
    pub fn internal_slow_conv2d_backward(
        &self, grad_input: &Tensor, grad_weight: &Tensor, grad_bias: &Tensor, grad_output: &Tensor, weight: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_slow_conv2d_backward(grad_input, grad_weight, grad_bias, grad_output, weight, kernel_size, stride, padding).unwrap()
    }

    pub fn internal_sobol_engine_draw(
        quasi: &Tensor, n: i64, sobolstate: &Tensor, dimension: i64, num_generated: i64, dtype: impl Into<Option<Kind>>
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_sobol_engine_draw(quasi, n, sobolstate, dimension, num_generated, dtype).unwrap()
    }

    pub fn internal_sobol_engine_ff_(
        &mut self, n: i64, sobolstate: &Tensor, dimension: i64, num_generated: i64
    ) -> Tensor {
    ...
    pub fn internal_softmax_backward_data_out(
        grad_input: &Tensor, grad_output: &Tensor, output: &Tensor, dim: i64, input_dtype: Kind
    ) -> Tensor {
        Tensor::f_internal_softmax_backward_data_out(grad_input, grad_output, output, dim, input_dtype).unwrap()
    }
    ...
    pub fn internal_sparse_addmm_out(
        &self, out: &Tensor, mat1: &Tensor, mat2: &Tensor
    ) -> Tensor {
        self.f_internal_sparse_addmm_out(out, mat1, mat2).unwrap()
    }

    pub fn internal_sparse_broadcast_to(
        &self, size: impl IntList
    ) -> Tensor {
    ...
    pub fn internal_sparse_broadcast_to_copy_out(
        &self, out: &Tensor, size: impl IntList
    ) -> Tensor {
        self.f_internal_sparse_broadcast_to_copy_out(out, size).unwrap()
    }

    pub fn internal_sparse_bsc_tensor_unsafe(
        ccol_indices: &Tensor, row_indices: &Tensor, values: &Tensor, size: impl IntList, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_internal_sparse_bsc_tensor_unsafe(ccol_indices, row_indices, values, size, options).unwrap()
    }

    pub fn internal_sparse_bsr_tensor_unsafe(
        crow_indices: &Tensor, col_indices: &Tensor, values: &Tensor, size: impl IntList, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_internal_sparse_bsr_tensor_unsafe(crow_indices, col_indices, values, size, options).unwrap()
    }

    pub fn internal_sparse_compressed_tensor_unsafe(
        compressed_indices: &Tensor, plain_indices: &Tensor, values: &Tensor, size: impl IntList, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_internal_sparse_compressed_tensor_unsafe(compressed_indices, plain_indices, values, size, options).unwrap()
    }

    pub fn internal_sparse_coo_tensor_unsafe(
        indices: &Tensor, values: &Tensor, size: impl IntList, options: (Kind, Device), is_coalesced: bool
    ) -> Tensor {
        Tensor::f_internal_sparse_coo_tensor_unsafe(indices, values, size, options, is_coalesced).unwrap()
    }

    pub fn internal_sparse_coo_tensor_with_dims(
        sparse_dim: i64, dense_dim: i64, size: impl IntList, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_internal_sparse_coo_tensor_with_dims(sparse_dim, dense_dim, size, options).unwrap()
    }

    pub fn internal_sparse_coo_tensor_with_dims_and_tensors(
        sparse_dim: i64, dense_dim: i64, size: impl IntList, indices: &Tensor, values: &Tensor, options: (Kind, Device), is_coalesced: bool
    ) -> Tensor {
        Tensor::f_internal_sparse_coo_tensor_with_dims_and_tensors(sparse_dim, dense_dim, size, indices, values, options, is_coalesced).unwrap()
    }

    pub fn internal_sparse_coo_tensor_with_dims_and_tensors_out(
        out: &Tensor, sparse_dim: i64, dense_dim: i64, size: impl IntList, indices: &Tensor, values: &Tensor, is_coalesced: bool
    ) -> Tensor {
        Tensor::f_internal_sparse_coo_tensor_with_dims_and_tensors_out(out, sparse_dim, dense_dim, size, indices, values, is_coalesced).unwrap()
    }

    pub fn internal_sparse_coo_tensor_with_dims_out(
        out: &Tensor, sparse_dim: i64, dense_dim: i64, size: impl IntList
    ) -> Tensor {
        Tensor::f_internal_sparse_coo_tensor_with_dims_out(out, sparse_dim, dense_dim, size).unwrap()
    }

    pub fn internal_sparse_csc_tensor_unsafe(
        ccol_indices: &Tensor, row_indices: &Tensor, values: &Tensor, size: impl IntList, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_internal_sparse_csc_tensor_unsafe(ccol_indices, row_indices, values, size, options).unwrap()
    }

    pub fn internal_sparse_csr_prod(
        &self, dim: impl IntList, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
        self.f_internal_sparse_csr_prod(dim, keepdim, dtype).unwrap()
    }

    pub fn internal_sparse_csr_prod_dim_dtype_out(
        &self, out: &Tensor, dim: impl IntList, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
    ...
    pub fn internal_sparse_csr_tensor_unsafe(
        ...
        Tensor::f_internal_sparse_csr_tensor_unsafe(crow_indices, col_indices, values, size, options).unwrap()
    }
    ...
    pub fn internal_sparse_log_softmax_backward_data(
        &self, grad_output: &Tensor, output: &Tensor, dim: i64
    ) -> Tensor {
    ...
    pub fn internal_sparse_log_softmax_backward_data_out(
        &self, out: &Tensor, grad_output: &Tensor, output: &Tensor, dim: i64
    ) -> Tensor {
    ...
    pub fn internal_sparse_log_softmax_int(
        &self, dim: i64, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
    ...
    pub fn internal_sparse_mm_reduce(
        sparse: &Tensor, dense: &Tensor, reduce: &str
    ) -> Tensor {
        Tensor::f_internal_sparse_mm_reduce(sparse, dense, reduce).unwrap()
    }

    pub fn internal_sparse_mm_reduce_impl(
        &self, other: &Tensor, reduce: &str
    ) -> (Tensor, Tensor) {
        self.f_internal_sparse_mm_reduce_impl(other, reduce).unwrap()
    }

    pub fn internal_sparse_semi_structured_linear<T: Borrow<Tensor>>(
        &self, weight: &Tensor, meta: &Tensor, bias: Option<T>, activation: &str, out_dtype: impl Into<Option<Kind>>
    ) -> Tensor {
        self.f_internal_sparse_semi_structured_linear(weight, meta, bias, activation, out_dtype).unwrap()
    }
    ...
    pub fn internal_sparse_sparse_matmul(
        &self, other: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_spdiags(
        diagonals: &Tensor, offsets: &Tensor, shape: impl IntList, layout: Option<Layout>
    ) -> Tensor {
        Tensor::f_internal_spdiags(diagonals, offsets, shape, layout).unwrap()
    }

    pub fn internal_spdiags_out(
        out: &Tensor, diagonals: &Tensor, offsets: &Tensor, shape: impl IntList, layout: Option<Layout>
    ) -> Tensor {
        Tensor::f_internal_spdiags_out(out, diagonals, offsets, shape, layout).unwrap()
    }

    pub fn internal_stack<T: Borrow<Tensor>>(
        tensors: &[T], dim: i64
    ) -> Tensor {
    ...
    pub fn internal_stack_out<T: Borrow<Tensor>>(
        out: &Tensor, tensors: &[T], dim: i64
    ) -> Tensor {
        Tensor::f_internal_stack_out(out, tensors, dim).unwrap()
    }

    pub fn internal_standard_gamma(
        &self, 
    ) -> Tensor {
        self.f_internal_standard_gamma().unwrap()
    }

    pub fn internal_standard_gamma_grad(
        &self, output: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_standard_gamma_grad_out(
        &self, out: &Tensor, output: &Tensor
    ) -> Tensor {
        self.f_internal_standard_gamma_grad_out(out, output).unwrap()
    }

    pub fn internal_standard_gamma_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_test_ambiguous_defaults_b(
        dummy: &Tensor, a: i64, b: &str
    ) -> Tensor {
        Tensor::f_internal_test_ambiguous_defaults_b(dummy, a, b).unwrap()
    }

    pub fn internal_test_autograd_multiple_dispatch(
        &self, 
    ) -> Tensor {
    ...
    pub fn internal_test_autograd_multiple_dispatch_view(
        &self, 
    ) -> Tensor {
        self.f_internal_test_autograd_multiple_dispatch_view().unwrap()
    }

    pub fn internal_test_autograd_multiple_dispatch_view_copy(
        &self, 
    ) -> Tensor {
    ...
    pub fn internal_test_check_tensor(
        &self, 
    ) -> Tensor {
        self.f_internal_test_check_tensor().unwrap()
    }

    pub fn internal_test_functorch_fallback(
        &self, other: &Tensor
    ) -> Tensor {
        self.f_internal_test_functorch_fallback(other).unwrap()
    }

    pub fn internal_test_functorch_fallback_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_test_serialization_subcmul(
        &self, other: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_test_string_default(
        dummy: &Tensor, a: &str, b: &str
    ) -> Tensor {
        Tensor::f_internal_test_string_default(dummy, a, b).unwrap()
    }

    pub fn internal_test_warn_in_autograd(
        &self, 
    ) -> Tensor {
        self.f_internal_test_warn_in_autograd().unwrap()
    }

    pub fn internal_test_warn_in_autograd_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_to_sparse_csc(
        &self, dense_dim: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_internal_to_sparse_csc(dense_dim).unwrap()
    }

    pub fn internal_to_sparse_csc_out(
        &self, out: &Tensor, dense_dim: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_internal_to_sparse_csc_out(out, dense_dim).unwrap()
    }

    pub fn internal_to_sparse_csr(
        &self, dense_dim: impl Into<Option<i64>>
    ) -> Tensor {
    ...
    pub fn internal_to_sparse_out(
        &self, out: &Tensor, layout: Option<Layout>, blocksize: impl IntListOption, dense_dim: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_internal_to_sparse_out(out, layout, blocksize, dense_dim).unwrap()
    }

    pub fn internal_to_sparse_semi_structured(
        dense: &Tensor
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_to_sparse_semi_structured(dense).unwrap()
    }

    pub fn internal_to_sparse_sparse_dim(
        &self, sparse_dim: i64
    ) -> Tensor {
        self.f_internal_to_sparse_sparse_dim(sparse_dim).unwrap()
    }

    pub fn internal_to_sparse_sparse_dim_out(
        &self, out: &Tensor, sparse_dim: i64
    ) -> Tensor {
    ...
    pub fn internal_transform_bias_rescale_qkv_out(
        ...
        Tensor::f_internal_transform_bias_rescale_qkv_out(out0, out1, out2, qkv, qkv_bias, num_heads).unwrap()
    }

    pub fn internal_transformer_encoder_layer_fwd<T: Borrow<Tensor>>(
        src: &Tensor, embed_dim: i64, num_heads: i64, qkv_weight: &Tensor, qkv_bias: &Tensor, proj_weight: &Tensor, proj_bias: &Tensor, use_gelu: bool, norm_first: bool, eps: f64, norm_weight_1: &Tensor, norm_bias_1: &Tensor, norm_weight_2: &Tensor, norm_bias_2: &Tensor, ffn_weight_1: &Tensor, ffn_bias_1: &Tensor, ffn_weight_2: &Tensor, ffn_bias_2: &Tensor, mask: Option<T>, mask_type: impl Into<Option<i64>>
    ) -> Tensor {
        Tensor::f_internal_transformer_encoder_layer_fwd(src, embed_dim, num_heads, qkv_weight, qkv_bias, proj_weight, proj_bias, use_gelu, norm_first, eps, norm_weight_1, norm_bias_1, norm_weight_2, norm_bias_2, ffn_weight_1, ffn_bias_1, ffn_weight_2, ffn_bias_2, mask, mask_type).unwrap()
    }
    ...
    pub fn internal_transformer_encoder_layer_fwd_out<T: Borrow<Tensor>>(
        ...
        Tensor::f_internal_transformer_encoder_layer_fwd_out(out, src, embed_dim, num_heads, qkv_weight, qkv_bias, proj_weight, proj_bias, use_gelu, norm_first, eps, norm_weight_1, norm_bias_1, norm_weight_2, norm_bias_2, ffn_weight_1, ffn_bias_1, ffn_weight_2, ffn_bias_2, mask, mask_type).unwrap()
    }

    pub fn internal_trilinear(
        i1: &Tensor, i2: &Tensor, i3: &Tensor, expand1: impl IntList, expand2: impl IntList, expand3: impl IntList, sumdim: impl IntList, unroll_dim: i64
    ) -> Tensor {
        Tensor::f_internal_trilinear(i1, i2, i3, expand1, expand2, expand3, sumdim, unroll_dim).unwrap()
    }

    pub fn internal_trilinear_out(
        out: &Tensor, i1: &Tensor, i2: &Tensor, i3: &Tensor, expand1: impl IntList, expand2: impl IntList, expand3: impl IntList, sumdim: impl IntList, unroll_dim: i64
    ) -> Tensor {
        Tensor::f_internal_trilinear_out(out, i1, i2, i3, expand1, expand2, expand3, sumdim, unroll_dim).unwrap()
    }

    pub fn internal_triton_multi_head_attention<T: Borrow<Tensor>>(
        query: &Tensor, key: &Tensor, value: &Tensor, embed_dim: i64, num_head: i64, qkv_weight: &Tensor, qkv_bias: &Tensor, proj_weight: &Tensor, proj_bias: &Tensor, mask: Option<T>
    ) -> Tensor {
        Tensor::f_internal_triton_multi_head_attention(query, key, value, embed_dim, num_head, qkv_weight, qkv_bias, proj_weight, proj_bias, mask).unwrap()
    }

    pub fn internal_triton_multi_head_attention_out<T: Borrow<Tensor>>(
        out: &Tensor, query: &Tensor, key: &Tensor, value: &Tensor, embed_dim: i64, num_head: i64, qkv_weight: &Tensor, qkv_bias: &Tensor, proj_weight: &Tensor, proj_bias: &Tensor, mask: Option<T>
    ) -> Tensor {
        Tensor::f_internal_triton_multi_head_attention_out(out, query, key, value, embed_dim, num_head, qkv_weight, qkv_bias, proj_weight, proj_bias, mask).unwrap()
    }
    ...
    pub fn internal_unique2(
        &self, sorted: bool, return_inverse: bool, return_counts: bool
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_unique2(sorted, return_inverse, return_counts).unwrap()
    }

    pub fn internal_unique2_out(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, sorted: bool, return_inverse: bool, return_counts: bool
    ) -> (Tensor, Tensor, Tensor) {
        self.f_internal_unique2_out(out0, out1, out2, sorted, return_inverse, return_counts).unwrap()
    }

    pub fn internal_unique_out(
        &self, out0: &Tensor, out1: &Tensor, sorted: bool, return_inverse: bool
    ) -> (Tensor, Tensor) {
        self.f_internal_unique_out(out0, out1, sorted, return_inverse).unwrap()
    }

    pub fn internal_unpack_dual(
        dual: &Tensor, level: i64
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_unpack_dual(dual, level).unwrap()
    }

    pub fn internal_unsafe_index<T: Borrow<Tensor>>(
        &self, indices: &[Option<T>]
    ) -> Tensor {
        self.f_internal_unsafe_index(indices).unwrap()
    }

    pub fn internal_unsafe_index_put<T: Borrow<Tensor>>(
        &self, indices: &[Option<T>], values: &Tensor, accumulate: bool
    ) -> Tensor {
        self.f_internal_unsafe_index_put(indices, values, accumulate).unwrap()
    }

    pub fn internal_unsafe_view(
        &self, size: impl IntList
    ) -> Tensor {
    ...
    pub fn internal_upsample_bicubic2d_aa(
        &self, output_size: impl IntList, align_corners: bool, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_internal_upsample_bicubic2d_aa(output_size, align_corners, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_bicubic2d_aa_backward(
        grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, align_corners: bool, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_internal_upsample_bicubic2d_aa_backward(grad_output, output_size, input_size, align_corners, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_bicubic2d_aa_backward_grad_input(
        grad_input: &Tensor, grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, align_corners: bool, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_internal_upsample_bicubic2d_aa_backward_grad_input(grad_input, grad_output, output_size, input_size, align_corners, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_bicubic2d_aa_out(
        &self, out: &Tensor, output_size: impl IntList, align_corners: bool, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_internal_upsample_bicubic2d_aa_out(out, output_size, align_corners, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_bicubic2d_aa_vec(
        &self, output_size: impl IntListOption, align_corners: bool, scale_factors: impl DoubleList
    ) -> Tensor {
        self.f_internal_upsample_bicubic2d_aa_vec(output_size, align_corners, scale_factors).unwrap()
    }

    pub fn internal_upsample_bilinear2d_aa(
        &self, output_size: impl IntList, align_corners: bool, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_internal_upsample_bilinear2d_aa(output_size, align_corners, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_bilinear2d_aa_backward(
        grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, align_corners: bool, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_internal_upsample_bilinear2d_aa_backward(grad_output, output_size, input_size, align_corners, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_bilinear2d_aa_backward_grad_input(
        grad_input: &Tensor, grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, align_corners: bool, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_internal_upsample_bilinear2d_aa_backward_grad_input(grad_input, grad_output, output_size, input_size, align_corners, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_bilinear2d_aa_out(
        &self, out: &Tensor, output_size: impl IntList, align_corners: bool, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_internal_upsample_bilinear2d_aa_out(out, output_size, align_corners, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_bilinear2d_aa_vec(
        &self, output_size: impl IntListOption, align_corners: bool, scale_factors: impl DoubleList
    ) -> Tensor {
        self.f_internal_upsample_bilinear2d_aa_vec(output_size, align_corners, scale_factors).unwrap()
    }

    pub fn internal_upsample_nearest_exact1d(
        &self, output_size: impl IntList, scales: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_internal_upsample_nearest_exact1d(output_size, scales).unwrap()
    }

    pub fn internal_upsample_nearest_exact1d_backward(
        grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, scales: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_internal_upsample_nearest_exact1d_backward(grad_output, output_size, input_size, scales).unwrap()
    }

    pub fn internal_upsample_nearest_exact1d_backward_grad_input(
        grad_input: &Tensor, grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, scales: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_internal_upsample_nearest_exact1d_backward_grad_input(grad_input, grad_output, output_size, input_size, scales).unwrap()
    }

    pub fn internal_upsample_nearest_exact1d_out(
        &self, out: &Tensor, output_size: impl IntList, scales: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_internal_upsample_nearest_exact1d_out(out, output_size, scales).unwrap()
    }

    pub fn internal_upsample_nearest_exact1d_vec(
        &self, output_size: impl IntListOption, scale_factors: impl DoubleList
    ) -> Tensor {
        self.f_internal_upsample_nearest_exact1d_vec(output_size, scale_factors).unwrap()
    }

    pub fn internal_upsample_nearest_exact2d(
        &self, output_size: impl IntList, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
    ...
    pub fn internal_upsample_nearest_exact2d_backward(
        grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_internal_upsample_nearest_exact2d_backward(grad_output, output_size, input_size, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_nearest_exact2d_backward_grad_input(
        grad_input: &Tensor, grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_internal_upsample_nearest_exact2d_backward_grad_input(grad_input, grad_output, output_size, input_size, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_nearest_exact2d_out(
        &self, out: &Tensor, output_size: impl IntList, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
    ...
    pub fn internal_upsample_nearest_exact3d(
        &self, output_size: impl IntList, scales_d: impl Into<Option<f64>>, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
    ...
    pub fn internal_upsample_nearest_exact3d_backward(
        grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, scales_d: impl Into<Option<f64>>, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_internal_upsample_nearest_exact3d_backward(grad_output, output_size, input_size, scales_d, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_nearest_exact3d_backward_grad_input(
        grad_input: &Tensor, grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, scales_d: impl Into<Option<f64>>, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_internal_upsample_nearest_exact3d_backward_grad_input(grad_input, grad_output, output_size, input_size, scales_d, scales_h, scales_w).unwrap()
    }

    pub fn internal_upsample_nearest_exact3d_out(
        &self, out: &Tensor, output_size: impl IntList, scales_d: impl Into<Option<f64>>, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_internal_upsample_nearest_exact3d_out(out, output_size, scales_d, scales_h, scales_w).unwrap()
    }
    ...
    pub fn internal_use_cudnn_ctc_loss(
        log_probs: &Tensor, targets: &Tensor, input_lengths: impl IntList, target_lengths: impl IntList, blank: i64
    ) -> bool {
        Tensor::f_internal_use_cudnn_ctc_loss(log_probs, targets, input_lengths, target_lengths, blank).unwrap()
    }
    ...
    pub fn internal_use_cudnn_ctc_loss_tensor(
        ...
        Tensor::f_internal_use_cudnn_ctc_loss_tensor(log_probs, targets, input_lengths, target_lengths, blank).unwrap()
    }

    pub fn internal_use_cudnn_rnn_flatten_weight(
    ...
    pub fn internal_validate_compressed_sparse_indices(
        is_crow: bool, compressed_idx: &Tensor, plain_idx: &Tensor, cdim: i64, dim: i64, nnz: i64
    ) {
        Tensor::f_internal_validate_compressed_sparse_indices(is_crow, compressed_idx, plain_idx, cdim, dim, nnz).unwrap()
    }

    pub fn internal_validate_sparse_bsc_tensor_args(
        ccol_indices: &Tensor, row_indices: &Tensor, values: &Tensor, size: impl IntList
    ) {
        Tensor::f_internal_validate_sparse_bsc_tensor_args(ccol_indices, row_indices, values, size).unwrap()
    }

    pub fn internal_validate_sparse_bsr_tensor_args(
        crow_indices: &Tensor, col_indices: &Tensor, values: &Tensor, size: impl IntList
    ) {
        Tensor::f_internal_validate_sparse_bsr_tensor_args(crow_indices, col_indices, values, size).unwrap()
    }

    pub fn internal_validate_sparse_compressed_tensor_args(
        compressed_indices: &Tensor, plain_indices: &Tensor, values: &Tensor, size: impl IntList, layout: Layout
    ) {
        Tensor::f_internal_validate_sparse_compressed_tensor_args(compressed_indices, plain_indices, values, size, layout).unwrap()
    }

    pub fn internal_validate_sparse_csc_tensor_args(
        ccol_indices: &Tensor, row_indices: &Tensor, values: &Tensor, size: impl IntList
    ) {
        Tensor::f_internal_validate_sparse_csc_tensor_args(ccol_indices, row_indices, values, size).unwrap()
    }

    pub fn internal_validate_sparse_csr_tensor_args(
        crow_indices: &Tensor, col_indices: &Tensor, values: &Tensor, size: impl IntList
    ) {
        Tensor::f_internal_validate_sparse_csr_tensor_args(crow_indices, col_indices, values, size).unwrap()
    }

    pub fn internal_values(
        &self, 
    ) -> Tensor {
        self.f_internal_values().unwrap()
    }

    pub fn internal_values_copy(
        &self, 
    ) -> Tensor {
        self.f_internal_values_copy().unwrap()
    }

    pub fn internal_values_copy_out(
        &self, out: &Tensor
    ) -> Tensor {
        self.f_internal_values_copy_out(out).unwrap()
    }

    pub fn internal_version(
        &self, 
    ) -> i64 {
    ...
    pub fn internal_weight_int4pack_mm(
        &self, mat2: &Tensor, qgroupsize: i64, qscaleandzeros: &Tensor
    ) -> Tensor {
        self.f_internal_weight_int4pack_mm(mat2, qgroupsize, qscaleandzeros).unwrap()
    }

    pub fn internal_weight_norm(
        v: &Tensor, g: &Tensor, dim: i64
    ) -> Tensor {
        Tensor::f_internal_weight_norm(v, g, dim).unwrap()
    }

    pub fn internal_weight_norm_differentiable_backward(
        grad_w: &Tensor, saved_v: &Tensor, saved_g: &Tensor, saved_norms: &Tensor, dim: i64
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_weight_norm_differentiable_backward(grad_w, saved_v, saved_g, saved_norms, dim).unwrap()
    }
    ...
    pub fn internal_weight_norm_interface_backward(
        ...
        Tensor::f_internal_weight_norm_interface_backward(grad_w, saved_v, saved_g, saved_norms, dim).unwrap()
    }

    pub fn internal_weight_norm_interface_backward_out(
        out0: &Tensor, out1: &Tensor, grad_w: &Tensor, saved_v: &Tensor, saved_g: &Tensor, saved_norms: &Tensor, dim: i64
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_weight_norm_interface_backward_out(out0, out1, grad_w, saved_v, saved_g, saved_norms, dim).unwrap()
    }

    pub fn internal_weight_norm_interface_out(
        out0: &Tensor, out1: &Tensor, v: &Tensor, g: &Tensor, dim: i64
    ) -> (Tensor, Tensor) {
    ...
    pub fn adaptive_max_pool2d_out(
        &self, out: &Tensor, indices: &Tensor, output_size: impl IntList
    ) -> (Tensor, Tensor) {
    ...
    pub fn g_add_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_add_scalar(other).unwrap()
    }

    pub fn g_add_scalar_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn addbmm_(
        &mut self, batch1: &Tensor, batch2: &Tensor
    ) -> Tensor {
        self.f_addbmm_(batch1, batch2).unwrap()
    }

    pub fn addbmm_out(
        &self, out: &Tensor, batch1: &Tensor, batch2: &Tensor
    ) -> Tensor {
    ...
    pub fn addcdiv_(
        &mut self, tensor1: &Tensor, tensor2: &Tensor
    ) -> Tensor {
        self.f_addcdiv_(tensor1, tensor2).unwrap()
    }

    pub fn addcdiv_out(
        &self, out: &Tensor, tensor1: &Tensor, tensor2: &Tensor
    ) -> Tensor {
    ...
    pub fn addmm_(
        &mut self, mat1: &Tensor, mat2: &Tensor
    ) -> Tensor {
    ...
    pub fn addmv_(
        &mut self, mat: &Tensor, vec: &Tensor
    ) -> Tensor {
        self.f_addmv_(mat, vec).unwrap()
    }

    pub fn addmv_out(
        &self, out: &Tensor, mat: &Tensor, vec: &Tensor
    ) -> Tensor {
    ...
    pub fn addr_(
        &mut self, vec1: &Tensor, vec2: &Tensor
    ) -> Tensor {
        self.f_addr_(vec1, vec2).unwrap()
    }

    pub fn addr_out(
        &self, out: &Tensor, vec1: &Tensor, vec2: &Tensor
    ) -> Tensor {
    ...
    pub fn align_tensors<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Vec<Tensor> {
    ...
    pub fn all_dims(
        &self, dim: impl IntListOption, keepdim: bool
    ) -> Tensor {
    ...
    pub fn all_out(
        &self, out: &Tensor, dim: i64, keepdim: bool
    ) -> Tensor {
    ...
    pub fn alpha_dropout_(
        &mut self, p: f64, train: bool
    ) -> Tensor {
        self.f_alpha_dropout_(p, train).unwrap()
    }

    pub fn amax(
        &self, dim: impl IntList, keepdim: bool
    ) -> Tensor {
        self.f_amax(dim, keepdim).unwrap()
    }

    pub fn amax_out(
        &self, out: &Tensor, dim: impl IntList, keepdim: bool
    ) -> Tensor {
    ...
    pub fn aminmax(
        &self, dim: impl Into<Option<i64>>, keepdim: bool
    ) -> (Tensor, Tensor) {
        self.f_aminmax(dim, keepdim).unwrap()
    }

    pub fn aminmax_out(
        &self, min: &Tensor, max: &Tensor, dim: impl Into<Option<i64>>, keepdim: bool
    ) -> (Tensor, Tensor) {
    ...
    pub fn argmax_out(
        &self, out: &Tensor, dim: impl Into<Option<i64>>, keepdim: bool
    ) -> Tensor {
    ...
    pub fn argsort_stable(
        &self, stable: bool, dim: i64, descending: bool
    ) -> Tensor {
        self.f_argsort_stable(stable, dim, descending).unwrap()
    }

    pub fn argsort_stable_out(
        &self, out: &Tensor, stable: bool, dim: i64, descending: bool
    ) -> Tensor {
    ...
    pub fn as_strided(
        &self, size: impl IntList, stride: impl IntList, storage_offset: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_as_strided(size, stride, storage_offset).unwrap()
    }

    pub fn as_strided_(
        &mut self, size: impl IntList, stride: impl IntList, storage_offset: impl Into<Option<i64>>
    ) -> Tensor {
    ...
    pub fn as_strided_copy_out(
        &self, out: &Tensor, size: impl IntList, stride: impl IntList, storage_offset: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_as_strided_copy_out(out, size, stride, storage_offset).unwrap()
    }

    pub fn as_strided_scatter(
        &self, src: &Tensor, size: impl IntList, stride: impl IntList, storage_offset: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_as_strided_scatter(src, size, stride, storage_offset).unwrap()
    }

    pub fn as_strided_scatter_out(
        &self, out: &Tensor, src: &Tensor, size: impl IntList, stride: impl IntList, storage_offset: impl Into<Option<i64>>
    ) -> Tensor {
    ...
    pub fn atleast_1d_sequence<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Vec<Tensor> {
    ...
    pub fn atleast_2d_sequence<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Vec<Tensor> {
    ...
    pub fn atleast_3d_sequence<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Vec<Tensor> {
    ...
    pub fn avg_pool1d(
        &self, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, ceil_mode: bool, count_include_pad: bool
    ) -> Tensor {
        self.f_avg_pool1d(kernel_size, stride, padding, ceil_mode, count_include_pad).unwrap()
    }

    pub fn avg_pool2d(
        &self, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, ceil_mode: bool, count_include_pad: bool, divisor_override: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_avg_pool2d(kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override).unwrap()
    }

    pub fn avg_pool2d_backward(
        &self, grad_output: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, ceil_mode: bool, count_include_pad: bool, divisor_override: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_avg_pool2d_backward(grad_output, kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override).unwrap()
    }

    pub fn avg_pool2d_backward_grad_input(
        &self, grad_input: &Tensor, grad_output: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, ceil_mode: bool, count_include_pad: bool, divisor_override: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_avg_pool2d_backward_grad_input(grad_input, grad_output, kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override).unwrap()
    }

    pub fn avg_pool2d_out(
        &self, out: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, ceil_mode: bool, count_include_pad: bool, divisor_override: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_avg_pool2d_out(out, kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override).unwrap()
    }

    pub fn avg_pool3d(
        &self, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, ceil_mode: bool, count_include_pad: bool, divisor_override: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_avg_pool3d(kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override).unwrap()
    }

    pub fn avg_pool3d_backward(
        &self, grad_output: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, ceil_mode: bool, count_include_pad: bool, divisor_override: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_avg_pool3d_backward(grad_output, kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override).unwrap()
    }

    pub fn avg_pool3d_backward_grad_input(
        &self, grad_input: &Tensor, grad_output: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, ceil_mode: bool, count_include_pad: bool, divisor_override: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_avg_pool3d_backward_grad_input(grad_input, grad_output, kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override).unwrap()
    }

    pub fn avg_pool3d_out(
        &self, out: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, ceil_mode: bool, count_include_pad: bool, divisor_override: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_avg_pool3d_out(out, kernel_size, stride, padding, ceil_mode, count_include_pad, divisor_override).unwrap()
    }

    pub fn baddbmm<S: Into<Scalar>>(
        &self, batch1: &Tensor, batch2: &Tensor, beta: S, alpha: S
    ) -> Tensor {
    ...
    pub fn batch_norm_backward_elemt<T: Borrow<Tensor>>(
        &self, grad_out: &Tensor, mean: &Tensor, invstd: &Tensor, weight: Option<T>, sum_dy: &Tensor, sum_dy_xmu: &Tensor, count: &Tensor
    ) -> Tensor {
        self.f_batch_norm_backward_elemt(grad_out, mean, invstd, weight, sum_dy, sum_dy_xmu, count).unwrap()
    }

    pub fn batch_norm_backward_elemt_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, grad_out: &Tensor, mean: &Tensor, invstd: &Tensor, weight: Option<T>, sum_dy: &Tensor, sum_dy_xmu: &Tensor, count: &Tensor
    ) -> Tensor {
        self.f_batch_norm_backward_elemt_out(out, grad_out, mean, invstd, weight, sum_dy, sum_dy_xmu, count).unwrap()
    }

    pub fn batch_norm_backward_reduce<T: Borrow<Tensor>>(
        &self, grad_out: &Tensor, mean: &Tensor, invstd: &Tensor, weight: Option<T>, input_g: bool, weight_g: bool, bias_g: bool
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        self.f_batch_norm_backward_reduce(grad_out, mean, invstd, weight, input_g, weight_g, bias_g).unwrap()
    }

    pub fn batch_norm_backward_reduce_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, out3: &Tensor, grad_out: &Tensor, mean: &Tensor, invstd: &Tensor, weight: Option<T>, input_g: bool, weight_g: bool, bias_g: bool
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        self.f_batch_norm_backward_reduce_out(out0, out1, out2, out3, grad_out, mean, invstd, weight, input_g, weight_g, bias_g).unwrap()
    }

    pub fn batch_norm_elemt<T: Borrow<Tensor>>(
        &self, weight: Option<T>, bias: Option<T>, mean: &Tensor, invstd: &Tensor, eps: f64
    ) -> Tensor {
        self.f_batch_norm_elemt(weight, bias, mean, invstd, eps).unwrap()
    }

    pub fn batch_norm_elemt_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: Option<T>, bias: Option<T>, mean: &Tensor, invstd: &Tensor, eps: f64
    ) -> Tensor {
        self.f_batch_norm_elemt_out(out, weight, bias, mean, invstd, eps).unwrap()
    }

    pub fn batch_norm_gather_stats<T: Borrow<Tensor>>(
        &self, mean: &Tensor, invstd: &Tensor, running_mean: Option<T>, running_var: Option<T>, momentum: f64, eps: f64, count: i64
    ) -> (Tensor, Tensor) {
        self.f_batch_norm_gather_stats(mean, invstd, running_mean, running_var, momentum, eps, count).unwrap()
    }

    pub fn batch_norm_gather_stats_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, mean: &Tensor, invstd: &Tensor, running_mean: Option<T>, running_var: Option<T>, momentum: f64, eps: f64, count: i64
    ) -> (Tensor, Tensor) {
        self.f_batch_norm_gather_stats_out(out0, out1, mean, invstd, running_mean, running_var, momentum, eps, count).unwrap()
    }

    pub fn batch_norm_gather_stats_with_counts<T: Borrow<Tensor>>(
        &self, mean: &Tensor, invstd: &Tensor, running_mean: Option<T>, running_var: Option<T>, momentum: f64, eps: f64, counts: &Tensor
    ) -> (Tensor, Tensor) {
        self.f_batch_norm_gather_stats_with_counts(mean, invstd, running_mean, running_var, momentum, eps, counts).unwrap()
    }

    pub fn batch_norm_gather_stats_with_counts_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, mean: &Tensor, invstd: &Tensor, running_mean: Option<T>, running_var: Option<T>, momentum: f64, eps: f64, counts: &Tensor
    ) -> (Tensor, Tensor) {
        self.f_batch_norm_gather_stats_with_counts_out(out0, out1, mean, invstd, running_mean, running_var, momentum, eps, counts).unwrap()
    }
    ...
    pub fn batch_norm_stats_out(
        &self, out0: &Tensor, out1: &Tensor, eps: f64
    ) -> (Tensor, Tensor) {
        self.f_batch_norm_stats_out(out0, out1, eps).unwrap()
    }

    pub fn batch_norm_update_stats<T: Borrow<Tensor>>(
        &self, running_mean: Option<T>, running_var: Option<T>, momentum: f64
    ) -> (Tensor, Tensor) {
    ...
    pub fn batch_norm_update_stats_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, running_mean: Option<T>, running_var: Option<T>, momentum: f64
    ) -> (Tensor, Tensor) {
    ...
    pub fn binary_cross_entropy_backward<T: Borrow<Tensor>>(
        &self, grad_output: &Tensor, target: &Tensor, weight: Option<T>, reduction: crate::Reduction
    ) -> Tensor {
    ...
    pub fn binary_cross_entropy_backward_grad_input<T: Borrow<Tensor>>(
        &self, grad_input: &Tensor, grad_output: &Tensor, target: &Tensor, weight: Option<T>, reduction: crate::Reduction
    ) -> Tensor {
        self.f_binary_cross_entropy_backward_grad_input(grad_input, grad_output, target, weight, reduction).unwrap()
    }
    ...
    pub fn binary_cross_entropy_with_logits_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, target: &Tensor, weight: Option<T>, pos_weight: Option<T>, reduction: crate::Reduction
    ) -> Tensor {
        self.f_binary_cross_entropy_with_logits_out(out, target, weight, pos_weight, reduction).unwrap()
    }
    ...
    pub fn bincount_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weights: Option<T>, minlength: i64
    ) -> Tensor {
    ...
    pub fn bitwise_and<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_bitwise_and(other).unwrap()
    }

    pub fn bitwise_and_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn bitwise_and_tensor_(
        &mut self, other: &Tensor
    ) -> Tensor {
        self.f_bitwise_and_tensor_(other).unwrap()
    }

    pub fn bitwise_and_tensor_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
    ...
    pub fn bitwise_not_out(
        &self, out: &Tensor
    ) -> Tensor {
        self.f_bitwise_not_out(out).unwrap()
    }

    pub fn bitwise_or<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_bitwise_or(other).unwrap()
    }

    pub fn bitwise_or_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn bitwise_or_tensor_(
        &mut self, other: &Tensor
    ) -> Tensor {
        self.f_bitwise_or_tensor_(other).unwrap()
    }

    pub fn bitwise_or_tensor_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
    ...
    pub fn bitwise_xor<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_bitwise_xor(other).unwrap()
    }

    pub fn bitwise_xor_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn bitwise_xor_tensor_(
        &mut self, other: &Tensor
    ) -> Tensor {
        self.f_bitwise_xor_tensor_(other).unwrap()
    }

    pub fn bitwise_xor_tensor_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
    ...
    pub fn block_diag<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Tensor {
    ...
    pub fn cartesian_prod<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Tensor {
    ...
    pub fn cauchy_(
        &mut self, median: f64, sigma: f64
    ) -> Tensor {
        self.f_cauchy_(median, sigma).unwrap()
    }

    pub fn cauchy_out(
        &self, out: &Tensor, median: f64, sigma: f64
    ) -> Tensor {
    ...
    pub fn ccol_indices_copy(
        &self, 
    ) -> Tensor {
        self.f_ccol_indices_copy().unwrap()
    }

    pub fn ccol_indices_copy_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn cdist(
        x1: &Tensor, x2: &Tensor, p: f64, compute_mode: impl Into<Option<i64>>
    ) -> Tensor {
    ...
    pub fn channel_shuffle_out(
        &self, out: &Tensor, groups: i64
    ) -> Tensor {
    ...
    pub fn cholesky_inverse_out(
        &self, out: &Tensor, upper: bool
    ) -> Tensor {
    ...
    pub fn cholesky_solve_out(
        &self, out: &Tensor, input2: &Tensor, upper: bool
    ) -> Tensor {
        self.f_cholesky_solve_out(out, input2, upper).unwrap()
    }

    pub fn choose_qparams_optimized(
        &self, numel: i64, n_bins: i64, ratio: f64, bit_width: i64
    ) -> (Tensor, Tensor) {
    ...
    pub fn clamp_max_tensor_(
        &mut self, max: &Tensor
    ) -> Tensor {
        self.f_clamp_max_tensor_(max).unwrap()
    }

    pub fn clamp_max_tensor_out(
        &self, out: &Tensor, max: &Tensor
    ) -> Tensor {
    ...
    pub fn col2im(
        &self, output_size: impl IntList, kernel_size: impl IntList, dilation: impl IntList, padding: impl IntList, stride: impl IntList
    ) -> Tensor {
        self.f_col2im(output_size, kernel_size, dilation, padding, stride).unwrap()
    }

    pub fn col2im_out(
        &self, out: &Tensor, output_size: impl IntList, kernel_size: impl IntList, dilation: impl IntList, padding: impl IntList, stride: impl IntList
    ) -> Tensor {
    ...
    pub fn col_indices_copy(
        &self, 
    ) -> Tensor {
        self.f_col_indices_copy().unwrap()
    }

    pub fn col_indices_copy_out(
        &self, out: &Tensor
    ) -> Tensor {
        self.f_col_indices_copy_out(out).unwrap()
    }

    pub fn column_stack<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Tensor {
    ...
    pub fn concatenate<T: Borrow<Tensor>>(
        tensors: &[T], dim: i64
    ) -> Tensor {
    ...
    pub fn conj_physical(
        &self, 
    ) -> Tensor {
        self.f_conj_physical().unwrap()
    }

    pub fn conj_physical_(
        &mut self, 
    ) -> Tensor {
        self.f_conj_physical_().unwrap()
    }

    pub fn conj_physical_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn constant_pad_nd_out(
        &self, out: &Tensor, pad: impl IntList
    ) -> Tensor {
    ...
    pub fn conv1d<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList, groups: i64
    ) -> Tensor {
    ...
    pub fn conv_depthwise3d_out<T: Borrow<Tensor>>(
        ...
        self.f_conv_depthwise3d_out(out, weight, kernel_size, bias, stride, padding, dilation).unwrap()
    }
    ...
    pub fn conv_tbc_out(
        &self, out: &Tensor, weight: &Tensor, bias: &Tensor, pad: i64
    ) -> Tensor {
        self.f_conv_tbc_out(out, weight, bias, pad).unwrap()
    }

    pub fn conv_transpose1d<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, stride: impl IntList, padding: impl IntList, output_padding: impl IntList, groups: i64, dilation: impl IntList
    ) -> Tensor {
    ...
    pub fn convolution<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList, transposed: bool, output_padding: impl IntList, groups: i64
    ) -> Tensor {
    ...
    pub fn convolution_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList, transposed: bool, output_padding: impl IntList, groups: i64
    ) -> Tensor {
        self.f_convolution_out(out, weight, bias, stride, padding, dilation, transposed, output_padding, groups).unwrap()
    }

    pub fn convolution_overrideable<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList, transposed: bool, output_padding: impl IntList, groups: i64
    ) -> Tensor {
        self.f_convolution_overrideable(weight, bias, stride, padding, dilation, transposed, output_padding, groups).unwrap()
    }

    pub fn convolution_overrideable_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList, transposed: bool, output_padding: impl IntList, groups: i64
    ) -> Tensor {
        self.f_convolution_overrideable_out(out, weight, bias, stride, padding, dilation, transposed, output_padding, groups).unwrap()
    }
    ...
    pub fn copysign_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_copysign_scalar(other).unwrap()
    }

    pub fn copysign_scalar_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn count_nonzero_out(
        &self, out: &Tensor, dim: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_count_nonzero_out(out, dim).unwrap()
    }

    pub fn cov<T: Borrow<Tensor>>(
        &self, correction: i64, fweights: Option<T>, aweights: Option<T>
    ) -> Tensor {
        self.f_cov(correction, fweights, aweights).unwrap()
    }

    pub fn cross(
        &self, other: &Tensor, dim: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_cross(other, dim).unwrap()
    }

    pub fn cross_entropy_loss<T: Borrow<Tensor>>(
        &self, target: &Tensor, weight: Option<T>, reduction: crate::Reduction, ignore_index: i64, label_smoothing: f64
    ) -> Tensor {
        self.f_cross_entropy_loss(target, weight, reduction, ignore_index, label_smoothing).unwrap()
    }

    pub fn cross_out(
        &self, out: &Tensor, other: &Tensor, dim: impl Into<Option<i64>>
    ) -> Tensor {
    ...
    pub fn crow_indices_copy(
        &self, 
    ) -> Tensor {
        self.f_crow_indices_copy().unwrap()
    }

    pub fn crow_indices_copy_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn ctc_loss(
        log_probs: &Tensor, targets: &Tensor, input_lengths: impl IntList, target_lengths: impl IntList, blank: i64, reduction: crate::Reduction, zero_infinity: bool
    ) -> Tensor {
    ...
    pub fn ctc_loss_tensor(
        ...
        Tensor::f_ctc_loss_tensor(log_probs, targets, input_lengths, target_lengths, blank, reduction, zero_infinity).unwrap()
    }
    ...
    pub fn cudnn_affine_grid_generator_backward_out(
        out: &Tensor, grad: &Tensor, n: i64, c: i64, h: i64, w: i64
    ) -> Tensor {
    ...
    pub fn cudnn_batch_norm_backward<T: Borrow<Tensor>>(
        &self, grad_output: &Tensor, weight: &Tensor, running_mean: Option<T>, running_var: Option<T>, save_mean: Option<T>, save_var: Option<T>, epsilon: f64, reservespace: &Tensor
    ) -> (Tensor, Tensor, Tensor) {
        self.f_cudnn_batch_norm_backward(grad_output, weight, running_mean, running_var, save_mean, save_var, epsilon, reservespace).unwrap()
    }

    pub fn cudnn_batch_norm_backward_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, grad_output: &Tensor, weight: &Tensor, running_mean: Option<T>, running_var: Option<T>, save_mean: Option<T>, save_var: Option<T>, epsilon: f64, reservespace: &Tensor
    ) -> (Tensor, Tensor, Tensor) {
        self.f_cudnn_batch_norm_backward_out(out0, out1, out2, grad_output, weight, running_mean, running_var, save_mean, save_var, epsilon, reservespace).unwrap()
    }

    pub fn cudnn_batch_norm_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, out3: &Tensor, weight: &Tensor, bias: Option<T>, running_mean: Option<T>, running_var: Option<T>, training: bool, exponential_average_factor: f64, epsilon: f64
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        self.f_cudnn_batch_norm_out(out0, out1, out2, out3, weight, bias, running_mean, running_var, training, exponential_average_factor, epsilon).unwrap()
    }

    pub fn cudnn_convolution(
        &self, weight: &Tensor, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, benchmark: bool, deterministic: bool, allow_tf32: bool
    ) -> Tensor {
        self.f_cudnn_convolution(weight, padding, stride, dilation, groups, benchmark, deterministic, allow_tf32).unwrap()
    }

    pub fn cudnn_convolution_add_relu<T: Borrow<Tensor>, S: Into<Scalar>>(
        &self, weight: &Tensor, z: &Tensor, alpha: S, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList, groups: i64
    ) -> Tensor {
        self.f_cudnn_convolution_add_relu(weight, z, alpha, bias, stride, padding, dilation, groups).unwrap()
    }

    pub fn cudnn_convolution_add_relu_out<T: Borrow<Tensor>, S: Into<Scalar>>(
        &self, out: &Tensor, weight: &Tensor, z: &Tensor, alpha: S, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList, groups: i64
    ) -> Tensor {
        self.f_cudnn_convolution_add_relu_out(out, weight, z, alpha, bias, stride, padding, dilation, groups).unwrap()
    }

    pub fn cudnn_convolution_out(
        &self, out: &Tensor, weight: &Tensor, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, benchmark: bool, deterministic: bool, allow_tf32: bool
    ) -> Tensor {
        self.f_cudnn_convolution_out(out, weight, padding, stride, dilation, groups, benchmark, deterministic, allow_tf32).unwrap()
    }
    ...
    pub fn cudnn_convolution_relu_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, bias: Option<T>, stride: impl IntList, padding: impl IntList, dilation: impl IntList, groups: i64
    ) -> Tensor {
        self.f_cudnn_convolution_relu_out(out, weight, bias, stride, padding, dilation, groups).unwrap()
    }

    pub fn cudnn_convolution_transpose(
        &self, weight: &Tensor, padding: impl IntList, output_padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, benchmark: bool, deterministic: bool, allow_tf32: bool
    ) -> Tensor {
        self.f_cudnn_convolution_transpose(weight, padding, output_padding, stride, dilation, groups, benchmark, deterministic, allow_tf32).unwrap()
    }

    pub fn cudnn_convolution_transpose_out(
        &self, out: &Tensor, weight: &Tensor, padding: impl IntList, output_padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, benchmark: bool, deterministic: bool, allow_tf32: bool
    ) -> Tensor {
        self.f_cudnn_convolution_transpose_out(out, weight, padding, output_padding, stride, dilation, groups, benchmark, deterministic, allow_tf32).unwrap()
    }
    ...
    pub fn cudnn_grid_sampler_backward_out(
        &self, out0: &Tensor, out1: &Tensor, grid: &Tensor, grad_output: &Tensor
    ) -> (Tensor, Tensor) {
        self.f_cudnn_grid_sampler_backward_out(out0, out1, grid, grad_output).unwrap()
    }

    pub fn cudnn_grid_sampler_out(
        &self, out: &Tensor, grid: &Tensor
    ) -> Tensor {
        self.f_cudnn_grid_sampler_out(out, grid).unwrap()
    }

    pub fn cudnn_is_acceptable(
        &self, 
    ) -> bool {
    ...
    pub fn cummax_out(
        &self, values: &Tensor, indices: &Tensor, dim: i64
    ) -> (Tensor, Tensor) {
        self.f_cummax_out(values, indices, dim).unwrap()
    }

    pub fn cummaxmin_backward(
        &self, grad: &Tensor, indices: &Tensor, dim: i64
    ) -> Tensor {
    ...
    pub fn cumprod_(
        &mut self, dim: i64, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
        self.f_cumprod_(dim, dtype).unwrap()
    }

    pub fn cumprod_backward(
        &self, grad: &Tensor, dim: i64, output: &Tensor
    ) -> Tensor {
        self.f_cumprod_backward(grad, dim, output).unwrap()
    }

    pub fn cumprod_out(
        &self, out: &Tensor, dim: i64, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
    ...
    pub fn cumulative_trapezoid_x(
        y: &Tensor, x: &Tensor, dim: i64
    ) -> Tensor {
    ...
    pub fn dequantize_self_out(
        &self, out: &Tensor
    ) -> Tensor {
        self.f_dequantize_self_out(out).unwrap()
    }

    pub fn dequantize_tensors<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Vec<Tensor> {
    ...
    pub fn diag_embed_out(
        &self, out: &Tensor, offset: i64, dim1: i64, dim2: i64
    ) -> Tensor {
        self.f_diag_embed_out(out, offset, dim1, dim2).unwrap()
    }

    pub fn diag_out(
        &self, out: &Tensor, diagonal: i64
    ) -> Tensor {
    ...
    pub fn div_out_mode(
        &self, out: &Tensor, other: &Tensor, rounding_mode: &str
    ) -> Tensor {
        self.f_div_out_mode(out, other, rounding_mode).unwrap()
    }

    pub fn g_div_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_div_scalar(other).unwrap()
    }

    pub fn g_div_scalar_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn g_div_tensor_mode(
        &self, other: &Tensor, rounding_mode: &str
    ) -> Tensor {
        self.f_div_tensor_mode(other, rounding_mode).unwrap()
    }

    pub fn g_div_tensor_mode_(
        &mut self, other: &Tensor, rounding_mode: &str
    ) -> Tensor {
    ...
    pub fn divide_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_divide_scalar(other).unwrap()
    }

    pub fn divide_scalar_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn dsplit_array(
        &self, indices: impl IntList
    ) -> Vec<Tensor> {
        self.f_dsplit_array(indices).unwrap()
    }

    pub fn dstack<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Tensor {
        Tensor::f_dstack(tensors).unwrap()
    }

    pub fn dstack_out<T: Borrow<Tensor>>(
        out: &Tensor, tensors: &[T]
    ) -> Tensor {
    ...
    pub fn einsum<T: Borrow<Tensor>>(
        equation: &str, tensors: &[T], path: impl IntListOption
    ) -> Tensor {
    ...
    pub fn elu_backward<S: Into<Scalar>>(
        grad_output: &Tensor, alpha: S, scale: S, input_scale: S, is_result: bool, self_or_result: &Tensor
    ) -> Tensor {
        Tensor::f_elu_backward(grad_output, alpha, scale, input_scale, is_result, self_or_result).unwrap()
    }

    pub fn elu_backward_grad_input<S: Into<Scalar>>(
        grad_input: &Tensor, grad_output: &Tensor, alpha: S, scale: S, input_scale: S, is_result: bool, self_or_result: &Tensor
    ) -> Tensor {
        Tensor::f_elu_backward_grad_input(grad_input, grad_output, alpha, scale, input_scale, is_result, self_or_result).unwrap()
    }
    ...
    pub fn embedding_bag<T: Borrow<Tensor>>(
        weight: &Tensor, indices: &Tensor, offsets: &Tensor, scale_grad_by_freq: bool, mode: i64, sparse: bool, per_sample_weights: Option<T>, include_last_offset: bool
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        Tensor::f_embedding_bag(weight, indices, offsets, scale_grad_by_freq, mode, sparse, per_sample_weights, include_last_offset).unwrap()
    }

    pub fn embedding_bag_padding_idx<T: Borrow<Tensor>>(
        weight: &Tensor, indices: &Tensor, offsets: &Tensor, scale_grad_by_freq: bool, mode: i64, sparse: bool, per_sample_weights: Option<T>, include_last_offset: bool, padding_idx: impl Into<Option<i64>>
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        Tensor::f_embedding_bag_padding_idx(weight, indices, offsets, scale_grad_by_freq, mode, sparse, per_sample_weights, include_last_offset, padding_idx).unwrap()
    }

    pub fn embedding_dense_backward(
        grad_output: &Tensor, indices: &Tensor, num_weights: i64, padding_idx: i64, scale_grad_by_freq: bool
    ) -> Tensor {
        Tensor::f_embedding_dense_backward(grad_output, indices, num_weights, padding_idx, scale_grad_by_freq).unwrap()
    }

    pub fn embedding_dense_backward_out(
        out: &Tensor, grad_output: &Tensor, indices: &Tensor, num_weights: i64, padding_idx: i64, scale_grad_by_freq: bool
    ) -> Tensor {
        Tensor::f_embedding_dense_backward_out(out, grad_output, indices, num_weights, padding_idx, scale_grad_by_freq).unwrap()
    }

    pub fn embedding_out(
        out: &Tensor, weight: &Tensor, indices: &Tensor, padding_idx: i64, scale_grad_by_freq: bool, sparse: bool
    ) -> Tensor {
        Tensor::f_embedding_out(out, weight, indices, padding_idx, scale_grad_by_freq, sparse).unwrap()
    }
    ...
    pub fn embedding_renorm_(
        &mut self, indices: &Tensor, max_norm: f64, norm_type: f64
    ) -> Tensor {
        self.f_embedding_renorm_(indices, max_norm, norm_type).unwrap()
    }

    pub fn embedding_renorm_out(
        &self, out: &Tensor, indices: &Tensor, max_norm: f64, norm_type: f64
    ) -> Tensor {
    ...
    pub fn expand(
        &self, size: impl IntList, implicit: bool
    ) -> Tensor {
    ...
    pub fn expand_copy_out(
        &self, out: &Tensor, size: impl IntList, implicit: bool
    ) -> Tensor {
    ...
    pub fn exponential_out(
        &self, out: &Tensor, lambd: f64
    ) -> Tensor {
    ...
    pub fn fake_quantize_per_channel_affine(
        &self, scale: &Tensor, zero_point: &Tensor, axis: i64, quant_min: i64, quant_max: i64
    ) -> Tensor {
        self.f_fake_quantize_per_channel_affine(scale, zero_point, axis, quant_min, quant_max).unwrap()
    }

    pub fn fake_quantize_per_channel_affine_cachemask(
        &self, scale: &Tensor, zero_point: &Tensor, axis: i64, quant_min: i64, quant_max: i64
    ) -> (Tensor, Tensor) {
        self.f_fake_quantize_per_channel_affine_cachemask(scale, zero_point, axis, quant_min, quant_max).unwrap()
    }

    pub fn fake_quantize_per_channel_affine_cachemask_backward(
        grad: &Tensor, mask: &Tensor
    ) -> Tensor {
    ...
    pub fn fake_quantize_per_channel_affine_cachemask_out(
        &self, out0: &Tensor, out1: &Tensor, scale: &Tensor, zero_point: &Tensor, axis: i64, quant_min: i64, quant_max: i64
    ) -> (Tensor, Tensor) {
        self.f_fake_quantize_per_channel_affine_cachemask_out(out0, out1, scale, zero_point, axis, quant_min, quant_max).unwrap()
    }

    pub fn fake_quantize_per_tensor_affine(
        &self, scale: f64, zero_point: i64, quant_min: i64, quant_max: i64
    ) -> Tensor {
    ...
    pub fn fake_quantize_per_tensor_affine_cachemask(
        ...
        self.f_fake_quantize_per_tensor_affine_cachemask(scale, zero_point, quant_min, quant_max).unwrap()
    }
    ...
    pub fn fake_quantize_per_tensor_affine_cachemask_out(
        &self, out0: &Tensor, out1: &Tensor, scale: f64, zero_point: i64, quant_min: i64, quant_max: i64
    ) -> (Tensor, Tensor) {
        self.f_fake_quantize_per_tensor_affine_cachemask_out(out0, out1, scale, zero_point, quant_min, quant_max).unwrap()
    }

    pub fn fake_quantize_per_tensor_affine_tensor_qparams(
        &self, scale: &Tensor, zero_point: &Tensor, quant_min: i64, quant_max: i64
    ) -> Tensor {
        self.f_fake_quantize_per_tensor_affine_tensor_qparams(scale, zero_point, quant_min, quant_max).unwrap()
    }

    pub fn fbgemm_linear_fp16_weight(
        &self, packed_weight: &Tensor, bias: &Tensor
    ) -> Tensor {
    ...
    pub fn fbgemm_linear_int8_weight<S: Into<Scalar>>(
        &self, weight: &Tensor, packed: &Tensor, col_offsets: &Tensor, weight_scale: S, weight_zero_point: S, bias: &Tensor
    ) -> Tensor {
        self.f_fbgemm_linear_int8_weight(weight, packed, col_offsets, weight_scale, weight_zero_point, bias).unwrap()
    }

    pub fn fbgemm_linear_int8_weight_fp32_activation<S: Into<Scalar>>(
        &self, weight: &Tensor, packed: &Tensor, col_offsets: &Tensor, weight_scale: S, weight_zero_point: S, bias: &Tensor
    ) -> Tensor {
        self.f_fbgemm_linear_int8_weight_fp32_activation(weight, packed, col_offsets, weight_scale, weight_zero_point, bias).unwrap()
    }

    pub fn fbgemm_pack_gemm_matrix_fp16(
        &self, 
    ) -> Tensor {
    ...
    pub fn fbgemm_pack_quantized_matrix_kn(
        &self, k: i64, n: i64
    ) -> Tensor {
    ...
    pub fn fft_fft(
        &self, n: impl Into<Option<i64>>, dim: i64, norm: &str
    ) -> Tensor {
        self.f_fft_fft(n, dim, norm).unwrap()
    }

    pub fn fft_fft2(
        &self, s: impl IntListOption, dim: impl IntList, norm: &str
    ) -> Tensor {
        self.f_fft_fft2(s, dim, norm).unwrap()
    }

    pub fn fft_fft2_out(
        &self, out: &Tensor, s: impl IntListOption, dim: impl IntList, norm: &str
    ) -> Tensor {
        self.f_fft_fft2_out(out, s, dim, norm).unwrap()
    }

    pub fn fft_fft_out(
        &self, out: &Tensor, n: impl Into<Option<i64>>, dim: i64, norm: &str
    ) -> Tensor {
        self.f_fft_fft_out(out, n, dim, norm).unwrap()
    }

    pub fn fft_fftfreq(
        n: i64, d: f64, options: (Kind, Device)
    ) -> Tensor {
    ...
    pub fn fft_fftn(
        &self, s: impl IntListOption, dim: impl IntListOption, norm: &str
    ) -> Tensor {
        self.f_fft_fftn(s, dim, norm).unwrap()
    }

    pub fn fft_fftn_out(
        &self, out: &Tensor, s: impl IntListOption, dim: impl IntListOption, norm: &str
    ) -> Tensor {
        self.f_fft_fftn_out(out, s, dim, norm).unwrap()
    }

    pub fn fft_fftshift(
        &self, dim: impl IntListOption
    ) -> Tensor {
    ...
    pub fn fill_tensor_(
        &mut self, value: &Tensor
    ) -> Tensor {
        self.f_fill_tensor_(value).unwrap()
    }

    pub fn fill_tensor_out(
        &self, out: &Tensor, value: &Tensor
    ) -> Tensor {
    ...
    pub fn flatten_dense_tensors<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Tensor {
    ...
    pub fn flip(
        &self, dims: impl IntList
    ) -> Tensor {
        self.f_flip(dims).unwrap()
    }

    pub fn flip_out(
        &self, out: &Tensor, dims: impl IntList
    ) -> Tensor {
    ...
    pub fn float_power_<S: Into<Scalar>>(
        &mut self, exponent: S
    ) -> Tensor {
    ...
    pub fn float_power_scalar_out<S: Into<Scalar>>(
        out: &Tensor, self_scalar: S, exponent: &Tensor
    ) -> Tensor {
        Tensor::f_float_power_scalar_out(out, self_scalar, exponent).unwrap()
    }

    pub fn float_power_tensor_(
        &mut self, exponent: &Tensor
    ) -> Tensor {
    ...
    pub fn floor_divide_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_floor_divide_scalar(other).unwrap()
    }

    pub fn floor_divide_scalar_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
        self.f_floor_divide_scalar_(other).unwrap()
    }

    pub fn floor_divide_scalar_out<S: Into<Scalar>>(
        &self, out: &Tensor, other: S
    ) -> Tensor {
    ...
    pub fn fractional_max_pool2d(
        &self, kernel_size: impl IntList, output_size: impl IntList, random_samples: &Tensor
    ) -> (Tensor, Tensor) {
        self.f_fractional_max_pool2d(kernel_size, output_size, random_samples).unwrap()
    }

    pub fn fractional_max_pool2d_backward(
        &self, grad_output: &Tensor, kernel_size: impl IntList, output_size: impl IntList, indices: &Tensor
    ) -> Tensor {
    ...
    pub fn fractional_max_pool2d_backward_grad_input(
        &self, grad_input: &Tensor, grad_output: &Tensor, kernel_size: impl IntList, output_size: impl IntList, indices: &Tensor
    ) -> Tensor {
        self.f_fractional_max_pool2d_backward_grad_input(grad_input, grad_output, kernel_size, output_size, indices).unwrap()
    }

    pub fn fractional_max_pool2d_output(
        &self, output: &Tensor, indices: &Tensor, kernel_size: impl IntList, output_size: impl IntList, random_samples: &Tensor
    ) -> (Tensor, Tensor) {
        self.f_fractional_max_pool2d_output(output, indices, kernel_size, output_size, random_samples).unwrap()
    }
    ...
    pub fn fractional_max_pool3d_backward(
        ...
        self.f_fractional_max_pool3d_backward(grad_output, kernel_size, output_size, indices).unwrap()
    }

    pub fn fractional_max_pool3d_backward_grad_input(
        &self, grad_input: &Tensor, grad_output: &Tensor, kernel_size: impl IntList, output_size: impl IntList, indices: &Tensor
    ) -> Tensor {
        self.f_fractional_max_pool3d_backward_grad_input(grad_input, grad_output, kernel_size, output_size, indices).unwrap()
    }

    pub fn fractional_max_pool3d_output(
        &self, output: &Tensor, indices: &Tensor, kernel_size: impl IntList, output_size: impl IntList, random_samples: &Tensor
    ) -> (Tensor, Tensor) {
        self.f_fractional_max_pool3d_output(output, indices, kernel_size, output_size, random_samples).unwrap()
    }
    ...
    pub fn frexp_tensor_out(
        &self, mantissa: &Tensor, exponent: &Tensor
    ) -> (Tensor, Tensor) {
    ...
    pub fn from_file(
        filename: &str, shared: bool, size: impl Into<Option<i64>>, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_from_file(filename, shared, size, options).unwrap()
    }

    pub fn from_file_out(
        out: &Tensor, filename: &str, shared: bool, size: impl Into<Option<i64>>
    ) -> Tensor {
        Tensor::f_from_file_out(out, filename, shared, size).unwrap()
    }

    pub fn full<S: Into<Scalar>>(
        size: impl IntList, fill_value: S, options: (Kind, Device)
    ) -> Tensor {
    ...
    pub fn fused_moving_avg_obs_fake_quant(
        ...
        self.f_fused_moving_avg_obs_fake_quant(observer_on, fake_quant_on, running_min, running_max, scale, zero_point, averaging_const, quant_min, quant_max, ch_axis, per_row_fake_quant, symmetric_quant).unwrap()
    }

    pub fn gather(
        &self, dim: i64, index: &Tensor, sparse_grad: bool
    ) -> Tensor {
        self.f_gather(dim, index, sparse_grad).unwrap()
    }

    pub fn gather_backward(
        &self, grad: &Tensor, dim: i64, index: &Tensor, sparse_grad: bool
    ) -> Tensor {
        self.f_gather_backward(grad, dim, index, sparse_grad).unwrap()
    }

    pub fn gather_out(
        &self, out: &Tensor, dim: i64, index: &Tensor, sparse_grad: bool
    ) -> Tensor {
    ...
    pub fn geometric_out(
        &self, out: &Tensor, p: f64
    ) -> Tensor {
    ...
    pub fn glu_backward_jvp(
        grad_x: &Tensor, grad_glu: &Tensor, x: &Tensor, dgrad_glu: &Tensor, dx: &Tensor, dim: i64
    ) -> Tensor {
        Tensor::f_glu_backward_jvp(grad_x, grad_glu, x, dgrad_glu, dx, dim).unwrap()
    }

    pub fn glu_backward_jvp_out(
        out: &Tensor, grad_x: &Tensor, grad_glu: &Tensor, x: &Tensor, dgrad_glu: &Tensor, dx: &Tensor, dim: i64
    ) -> Tensor {
        Tensor::f_glu_backward_jvp_out(out, grad_x, grad_glu, x, dgrad_glu, dx, dim).unwrap()
    }

    pub fn glu_jvp(
        glu: &Tensor, x: &Tensor, dx: &Tensor, dim: i64
    ) -> Tensor {
        Tensor::f_glu_jvp(glu, x, dx, dim).unwrap()
    }

    pub fn glu_jvp_out(
        out: &Tensor, glu: &Tensor, x: &Tensor, dx: &Tensor, dim: i64
    ) -> Tensor {
    ...
    pub fn greater<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_greater(other).unwrap()
    }

    pub fn greater_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
        self.f_greater_(other).unwrap()
    }

    pub fn greater_equal<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_greater_equal(other).unwrap()
    }

    pub fn greater_equal_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn greater_tensor_(
        &mut self, other: &Tensor
    ) -> Tensor {
        self.f_greater_tensor_(other).unwrap()
    }

    pub fn greater_tensor_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
    ...
    pub fn grid_sampler_2d_out(
        ...
        self.f_grid_sampler_2d_out(out, grid, interpolation_mode, padding_mode, align_corners).unwrap()
    }
    ...
    pub fn grid_sampler_3d_out(
        ...
        self.f_grid_sampler_3d_out(out, grid, interpolation_mode, padding_mode, align_corners).unwrap()
    }
    ...
    pub fn gru_data<T: Borrow<Tensor>>(
        ...
        Tensor::f_gru_data(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional).unwrap()
    }
    ...
    pub fn hamming_window_periodic_alpha_beta(
        ...
        Tensor::f_hamming_window_periodic_alpha_beta(window_length, periodic, alpha, beta, options).unwrap()
    }

    pub fn hamming_window_periodic_alpha_beta_out(
        out: &Tensor, window_length: i64, periodic: bool, alpha: f64, beta: f64
    ) -> Tensor {
        Tensor::f_hamming_window_periodic_alpha_beta_out(out, window_length, periodic, alpha, beta).unwrap()
    }
    ...
    pub fn heaviside_(
        &mut self, values: &Tensor
    ) -> Tensor {
        self.f_heaviside_(values).unwrap()
    }

    pub fn heaviside_out(
        &self, out: &Tensor, values: &Tensor
    ) -> Tensor {
    ...
    pub fn histogram_bins_tensor_out<T: Borrow<Tensor>>(
        &self, hist: &Tensor, bin_edges: &Tensor, bins: &Tensor, weight: Option<T>, density: bool
    ) -> (Tensor, Tensor) {
    ...
    pub fn hstack<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Tensor {
        Tensor::f_hstack(tensors).unwrap()
    }

    pub fn hstack_out<T: Borrow<Tensor>>(
        out: &Tensor, tensors: &[T]
    ) -> Tensor {
    ...
    pub fn huber_loss(
        &self, target: &Tensor, reduction: crate::Reduction, delta: f64
    ) -> Tensor {
        self.f_huber_loss(target, reduction, delta).unwrap()
    }

    pub fn huber_loss_backward(
        &self, grad_output: &Tensor, target: &Tensor, reduction: crate::Reduction, delta: f64
    ) -> Tensor {
        self.f_huber_loss_backward(grad_output, target, reduction, delta).unwrap()
    }

    pub fn huber_loss_backward_out(
        &self, grad_input: &Tensor, grad_output: &Tensor, target: &Tensor, reduction: crate::Reduction, delta: f64
    ) -> Tensor {
        self.f_huber_loss_backward_out(grad_input, grad_output, target, reduction, delta).unwrap()
    }

    pub fn huber_loss_out(
        &self, out: &Tensor, target: &Tensor, reduction: crate::Reduction, delta: f64
    ) -> Tensor {
    ...
    pub fn im2col(
        &self, kernel_size: impl IntList, dilation: impl IntList, padding: impl IntList, stride: impl IntList
    ) -> Tensor {
        self.f_im2col(kernel_size, dilation, padding, stride).unwrap()
    }

    pub fn im2col_out(
        &self, out: &Tensor, kernel_size: impl IntList, dilation: impl IntList, padding: impl IntList, stride: impl IntList
    ) -> Tensor {
    ...
    pub fn index_add_(
        &mut self, dim: i64, index: &Tensor, source: &Tensor
    ) -> Tensor {
        self.f_index_add_(dim, index, source).unwrap()
    }

    pub fn index_add_out(
        &self, out: &Tensor, dim: i64, index: &Tensor, source: &Tensor
    ) -> Tensor {
    ...
    pub fn index_fill_int_tensor_(
        &mut self, dim: i64, index: &Tensor, value: &Tensor
    ) -> Tensor {
        self.f_index_fill_int_tensor_(dim, index, value).unwrap()
    }

    pub fn index_fill_int_tensor_out(
        &self, out: &Tensor, dim: i64, index: &Tensor, value: &Tensor
    ) -> Tensor {
    ...
    pub fn index_put_<T: Borrow<Tensor>>(
        &mut self, indices: &[Option<T>], values: &Tensor, accumulate: bool
    ) -> Tensor {
        self.f_index_put_(indices, values, accumulate).unwrap()
    }

    pub fn index_put_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, indices: &[Option<T>], values: &Tensor, accumulate: bool
    ) -> Tensor {
        self.f_index_put_out(out, indices, values, accumulate).unwrap()
    }

    pub fn index_reduce(
        &self, dim: i64, index: &Tensor, source: &Tensor, reduce: &str, include_self: bool
    ) -> Tensor {
        self.f_index_reduce(dim, index, source, reduce, include_self).unwrap()
    }

    pub fn index_reduce_(
        &mut self, dim: i64, index: &Tensor, source: &Tensor, reduce: &str, include_self: bool
    ) -> Tensor {
        self.f_index_reduce_(dim, index, source, reduce, include_self).unwrap()
    }

    pub fn index_reduce_out(
        &self, out: &Tensor, dim: i64, index: &Tensor, source: &Tensor, reduce: &str, include_self: bool
    ) -> Tensor {
    ...
    pub fn isin_scalar_tensor<S: Into<Scalar>>(
        element: S, test_elements: &Tensor, assume_unique: bool, invert: bool
    ) -> Tensor {
        Tensor::f_isin_scalar_tensor(element, test_elements, assume_unique, invert).unwrap()
    }

    pub fn isin_scalar_tensor_out<S: Into<Scalar>>(
        out: &Tensor, element: S, test_elements: &Tensor, assume_unique: bool, invert: bool
    ) -> Tensor {
        Tensor::f_isin_scalar_tensor_out(out, element, test_elements, assume_unique, invert).unwrap()
    }

    pub fn isin_tensor_scalar<S: Into<Scalar>>(
        elements: &Tensor, test_element: S, assume_unique: bool, invert: bool
    ) -> Tensor {
        Tensor::f_isin_tensor_scalar(elements, test_element, assume_unique, invert).unwrap()
    }

    pub fn isin_tensor_scalar_out<S: Into<Scalar>>(
        out: &Tensor, elements: &Tensor, test_element: S, assume_unique: bool, invert: bool
    ) -> Tensor {
        Tensor::f_isin_tensor_scalar_out(out, elements, test_element, assume_unique, invert).unwrap()
    }

    pub fn isin_tensor_tensor_out(
        out: &Tensor, elements: &Tensor, test_elements: &Tensor, assume_unique: bool, invert: bool
    ) -> Tensor {
        Tensor::f_isin_tensor_tensor_out(out, elements, test_elements, assume_unique, invert).unwrap()
    }
    ...
    pub fn istft<T: Borrow<Tensor>>(
        &self, n_fft: i64, hop_length: impl Into<Option<i64>>, win_length: impl Into<Option<i64>>, window: Option<T>, center: bool, normalized: bool, onesided: bool, length: impl Into<Option<i64>>, return_complex: bool
    ) -> Tensor {
        self.f_istft(n_fft, hop_length, win_length, window, center, normalized, onesided, length, return_complex).unwrap()
    }
    ...
    pub fn kaiser_window_beta(
        window_length: i64, periodic: bool, beta: f64, options: (Kind, Device)
    ) -> Tensor {
    ...
    pub fn kl_div(
        &self, target: &Tensor, reduction: crate::Reduction, log_target: bool
    ) -> Tensor {
    ...
    pub fn layer_norm<T: Borrow<Tensor>>(
        &self, normalized_shape: impl IntList, weight: Option<T>, bias: Option<T>, eps: f64, cudnn_enable: bool
    ) -> Tensor {
    ...
    pub fn leaky_relu_backward<S: Into<Scalar>>(
        &self, grad_output: &Tensor, negative_slope: S, self_is_result: bool
    ) -> Tensor {
    ...
    pub fn leaky_relu_backward_grad_input<S: Into<Scalar>>(
        &self, grad_input: &Tensor, grad_output: &Tensor, negative_slope: S, self_is_result: bool
    ) -> Tensor {
        self.f_leaky_relu_backward_grad_input(grad_input, grad_output, negative_slope, self_is_result).unwrap()
    }
    ...
    pub fn less_equal_tensor_(
        &mut self, other: &Tensor
    ) -> Tensor {
        self.f_less_equal_tensor_(other).unwrap()
    }

    pub fn less_equal_tensor_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
    ...
    pub fn lift_fresh_copy(
        &self, 
    ) -> Tensor {
        self.f_lift_fresh_copy().unwrap()
    }

    pub fn lift_fresh_copy_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn linalg_cross_out(
        &self, out: &Tensor, other: &Tensor, dim: i64
    ) -> Tensor {
    ...
    pub fn linalg_eig_out(
        &self, eigenvalues: &Tensor, eigenvectors: &Tensor
    ) -> (Tensor, Tensor) {
    ...
    pub fn linalg_eigh_eigvals(
        &self, eigvals: &Tensor, eigvecs: &Tensor, uplo: &str
    ) -> (Tensor, Tensor) {
        self.f_linalg_eigh_eigvals(eigvals, eigvecs, uplo).unwrap()
    }

    pub fn linalg_eigvals(
        &self, 
    ) -> Tensor {
        self.f_linalg_eigvals().unwrap()
    }

    pub fn linalg_eigvals_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn linalg_eigvalsh_out(
        &self, out: &Tensor, uplo: &str
    ) -> Tensor {
    ...
    pub fn linalg_lstsq(
        &self, b: &Tensor, rcond: impl Into<Option<f64>>, driver: &str
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        self.f_linalg_lstsq(b, rcond, driver).unwrap()
    }

    pub fn linalg_lstsq_out(
        &self, solution: &Tensor, residuals: &Tensor, rank: &Tensor, singular_values: &Tensor, b: &Tensor, rcond: impl Into<Option<f64>>, driver: &str
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        self.f_linalg_lstsq_out(solution, residuals, rank, singular_values, b, rcond, driver).unwrap()
    }
    ...
    pub fn linalg_lu_solve_out(
        out: &Tensor, lu: &Tensor, pivots: &Tensor, b: &Tensor, left: bool, adjoint: bool
    ) -> Tensor {
    ...
    pub fn linalg_matmul_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
        self.f_linalg_matmul_out(out, other).unwrap()
    }

    pub fn linalg_matrix_exp(
        &self, 
    ) -> Tensor {
        self.f_linalg_matrix_exp().unwrap()
    }

    pub fn linalg_matrix_exp_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn linalg_matrix_rank_atol_rtol_tensor<T: Borrow<Tensor>>(
        &self, atol: Option<T>, rtol: Option<T>, hermitian: bool
    ) -> Tensor {
    ...
    pub fn linalg_norm<S: Into<Scalar>>(
        &self, ord: S, dim: impl IntListOption, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
        self.f_linalg_norm(ord, dim, keepdim, dtype).unwrap()
    }

    pub fn linalg_norm_ord_str(
        &self, ord: &str, dim: impl IntListOption, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
        self.f_linalg_norm_ord_str(ord, dim, keepdim, dtype).unwrap()
    }

    pub fn linalg_norm_ord_str_out(
        &self, out: &Tensor, ord: &str, dim: impl IntListOption, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
        self.f_linalg_norm_ord_str_out(out, ord, dim, keepdim, dtype).unwrap()
    }

    pub fn linalg_norm_out<S: Into<Scalar>>(
        &self, out: &Tensor, ord: S, dim: impl IntListOption, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
        self.f_linalg_norm_out(out, ord, dim, keepdim, dtype).unwrap()
    }

    pub fn linalg_pinv(
        &self, rcond: f64, hermitian: bool
    ) -> Tensor {
    ...
    pub fn linalg_qr_out(
        q: &Tensor, r: &Tensor, a: &Tensor, mode: &str
    ) -> (Tensor, Tensor) {
        Tensor::f_linalg_qr_out(q, r, a, mode).unwrap()
    }

    pub fn linalg_slogdet(
        a: &Tensor
    ) -> (Tensor, Tensor) {
    ...
    pub fn linalg_slogdet_out(
        sign: &Tensor, logabsdet: &Tensor, a: &Tensor
    ) -> (Tensor, Tensor) {
    ...
    pub fn log_normal_(
        &mut self, mean: f64, std: f64
    ) -> Tensor {
        self.f_log_normal_(mean, std).unwrap()
    }

    pub fn log_normal_out(
        &self, out: &Tensor, mean: f64, std: f64
    ) -> Tensor {
    ...
    pub fn logaddexp2_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
        self.f_logaddexp2_out(out, other).unwrap()
    }

    pub fn logaddexp_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
    ...
    pub fn lstm_data<T: Borrow<Tensor>>(
        ...
        Tensor::f_lstm_data(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional).unwrap()
    }

    pub fn lstm_mps_backward<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &[T], out2: &[T], grad_y: Option<T>, grad_hy: Option<T>, grad_cy: Option<T>, z_state: &Tensor, cell_state_fwd: &Tensor, layersoutputs: &Tensor, hx: &[T], params: &[T], has_biases: bool, num_layers: i64, dropout: f64, train: bool, bidirectional: bool, batch_first: bool
    ) {
        self.f_lstm_mps_backward(out0, out1, out2, grad_y, grad_hy, grad_cy, z_state, cell_state_fwd, layersoutputs, hx, params, has_biases, num_layers, dropout, train, bidirectional, batch_first).unwrap()
    }
    ...
    pub fn lu_solve_out(
        &self, out: &Tensor, lu_data: &Tensor, lu_pivots: &Tensor
    ) -> Tensor {
    ...
    pub fn masked_fill_tensor_(
        &mut self, mask: &Tensor, value: &Tensor
    ) -> Tensor {
        self.f_masked_fill_tensor_(mask, value).unwrap()
    }

    pub fn masked_fill_tensor_out(
        &self, out: &Tensor, mask: &Tensor, value: &Tensor
    ) -> Tensor {
    ...
    pub fn max_pool1d(
        &self, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool
    ) -> Tensor {
    ...
    pub fn max_pool2d_backward(
        &self, grad_output: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool
    ) -> Tensor {
        self.f_max_pool2d_backward(grad_output, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }

    pub fn max_pool2d_backward_out(
        &self, out: &Tensor, grad_output: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool
    ) -> Tensor {
        self.f_max_pool2d_backward_out(out, grad_output, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }
    ...
    pub fn max_pool2d_with_indices_backward(
        &self, grad_output: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool, indices: &Tensor
    ) -> Tensor {
    ...
    pub fn max_pool2d_with_indices_backward_grad_input(
        &self, grad_input: &Tensor, grad_output: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool, indices: &Tensor
    ) -> Tensor {
        self.f_max_pool2d_with_indices_backward_grad_input(grad_input, grad_output, kernel_size, stride, padding, dilation, ceil_mode, indices).unwrap()
    }

    pub fn max_pool2d_with_indices_out(
        &self, out: &Tensor, indices: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool
    ) -> (Tensor, Tensor) {
        self.f_max_pool2d_with_indices_out(out, indices, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }
    ...
    pub fn max_pool3d_with_indices_backward_grad_input(
        ...
        self.f_max_pool3d_with_indices_backward_grad_input(grad_input, grad_output, kernel_size, stride, padding, dilation, ceil_mode, indices).unwrap()
    }

    pub fn max_pool3d_with_indices_out(
        &self, out: &Tensor, indices: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool
    ) -> (Tensor, Tensor) {
        self.f_max_pool3d_with_indices_out(out, indices, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }

    pub fn max_unary_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn max_unpool2d(
        &self, indices: &Tensor, output_size: impl IntList
    ) -> Tensor {
    ...
    pub fn max_unpool3d(
        &self, indices: &Tensor, output_size: impl IntList, stride: impl IntList, padding: impl IntList
    ) -> Tensor {
        self.f_max_unpool3d(indices, output_size, stride, padding).unwrap()
    }

    pub fn max_unpool3d_out(
        &self, out: &Tensor, indices: &Tensor, output_size: impl IntList, stride: impl IntList, padding: impl IntList
    ) -> Tensor {
    ...
    pub fn mean(
        &self, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
        self.f_mean(dtype).unwrap()
    }

    pub fn mean_dim(
        &self, dim: impl IntListOption, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
        self.f_mean_dim(dim, keepdim, dtype).unwrap()
    }

    pub fn mean_out(
        &self, out: &Tensor, dim: impl IntListOption, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
    ...
    pub fn miopen_batch_norm_backward_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, grad_output: &Tensor, weight: &Tensor, running_mean: Option<T>, running_var: Option<T>, save_mean: Option<T>, save_var: Option<T>, epsilon: f64
    ) -> (Tensor, Tensor, Tensor) {
        self.f_miopen_batch_norm_backward_out(out0, out1, out2, grad_output, weight, running_mean, running_var, save_mean, save_var, epsilon).unwrap()
    }

    pub fn miopen_batch_norm_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, weight: &Tensor, bias: Option<T>, running_mean: Option<T>, running_var: Option<T>, training: bool, exponential_average_factor: f64, epsilon: f64
    ) -> (Tensor, Tensor, Tensor) {
        self.f_miopen_batch_norm_out(out0, out1, out2, weight, bias, running_mean, running_var, training, exponential_average_factor, epsilon).unwrap()
    }

    pub fn miopen_convolution<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, benchmark: bool, deterministic: bool
    ) -> Tensor {
    ...
    pub fn miopen_convolution_add_relu<T: Borrow<Tensor>, S: Into<Scalar>>(
        ...
        self.f_miopen_convolution_add_relu(weight, z, alpha, bias, stride, padding, dilation, groups).unwrap()
    }

    pub fn miopen_convolution_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, bias: Option<T>, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, benchmark: bool, deterministic: bool
    ) -> Tensor {
        self.f_miopen_convolution_out(out, weight, bias, padding, stride, dilation, groups, benchmark, deterministic).unwrap()
    }
    ...
    pub fn miopen_convolution_transpose<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, padding: impl IntList, output_padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, benchmark: bool, deterministic: bool
    ) -> Tensor {
    ...
    pub fn miopen_convolution_transpose_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, bias: Option<T>, padding: impl IntList, output_padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, benchmark: bool, deterministic: bool
    ) -> Tensor {
        self.f_miopen_convolution_transpose_out(out, weight, bias, padding, output_padding, stride, dilation, groups, benchmark, deterministic).unwrap()
    }

    pub fn miopen_depthwise_convolution<T: Borrow<Tensor>>(
        &self, weight: &Tensor, bias: Option<T>, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, benchmark: bool, deterministic: bool
    ) -> Tensor {
        self.f_miopen_depthwise_convolution(weight, bias, padding, stride, dilation, groups, benchmark, deterministic).unwrap()
    }

    pub fn miopen_depthwise_convolution_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, bias: Option<T>, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, benchmark: bool, deterministic: bool
    ) -> Tensor {
        self.f_miopen_depthwise_convolution_out(out, weight, bias, padding, stride, dilation, groups, benchmark, deterministic).unwrap()
    }

    pub fn miopen_rnn<T: Borrow<Tensor>>(
        &self, weight: &[T], weight_stride0: i64, hx: &Tensor, cx: Option<T>, mode: i64, hidden_size: i64, num_layers: i64, batch_first: bool, dropout: f64, train: bool, bidirectional: bool, batch_sizes: impl IntList, dropout_state: Option<T>
    ) -> (Tensor, Tensor, Tensor, Tensor, Tensor) {
        self.f_miopen_rnn(weight, weight_stride0, hx, cx, mode, hidden_size, num_layers, batch_first, dropout, train, bidirectional, batch_sizes, dropout_state).unwrap()
    }

    pub fn miopen_rnn_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, out3: &Tensor, out4: &Tensor, weight: &[T], weight_stride0: i64, hx: &Tensor, cx: Option<T>, mode: i64, hidden_size: i64, num_layers: i64, batch_first: bool, dropout: f64, train: bool, bidirectional: bool, batch_sizes: impl IntList, dropout_state: Option<T>
    ) -> (Tensor, Tensor, Tensor, Tensor, Tensor) {
        self.f_miopen_rnn_out(out0, out1, out2, out3, out4, weight, weight_stride0, hx, cx, mode, hidden_size, num_layers, batch_first, dropout, train, bidirectional, batch_sizes, dropout_state).unwrap()
    }
    ...
    pub fn mkldnn_max_pool2d_backward(
        &self, grad_output: &Tensor, output: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool
    ) -> Tensor {
        self.f_mkldnn_max_pool2d_backward(grad_output, output, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }

    pub fn mkldnn_max_pool2d_backward_out(
        &self, out: &Tensor, grad_output: &Tensor, output: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool
    ) -> Tensor {
        self.f_mkldnn_max_pool2d_backward_out(out, grad_output, output, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }

    pub fn mkldnn_max_pool2d_out(
        &self, out: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool
    ) -> Tensor {
        self.f_mkldnn_max_pool2d_out(out, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }
    ...
    pub fn mkldnn_max_pool3d_backward(
        ...
        self.f_mkldnn_max_pool3d_backward(grad_output, output, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }

    pub fn mkldnn_max_pool3d_backward_out(
        &self, out: &Tensor, grad_output: &Tensor, output: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool
    ) -> Tensor {
        self.f_mkldnn_max_pool3d_backward_out(out, grad_output, output, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }

    pub fn mkldnn_max_pool3d_out(
        &self, out: &Tensor, kernel_size: impl IntList, stride: impl IntList, padding: impl IntList, dilation: impl IntList, ceil_mode: bool
    ) -> Tensor {
        self.f_mkldnn_max_pool3d_out(out, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }

    pub fn mkldnn_reorder_conv2d_weight(
        &self, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, input_size: impl IntListOption
    ) -> Tensor {
    ...
    pub fn mkldnn_reorder_conv2d_weight_out(
        &self, out: &Tensor, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, input_size: impl IntListOption
    ) -> Tensor {
        self.f_mkldnn_reorder_conv2d_weight_out(out, padding, stride, dilation, groups, input_size).unwrap()
    }

    pub fn mkldnn_reorder_conv3d_weight(
        &self, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64
    ) -> Tensor {
        self.f_mkldnn_reorder_conv3d_weight(padding, stride, dilation, groups).unwrap()
    }

    pub fn mkldnn_reorder_conv3d_weight_out(
        &self, out: &Tensor, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64
    ) -> Tensor {
        self.f_mkldnn_reorder_conv3d_weight_out(out, padding, stride, dilation, groups).unwrap()
    }

    pub fn mkldnn_rnn_layer(
        &self, weight0: &Tensor, weight1: &Tensor, weight2: &Tensor, weight3: &Tensor, hx_: &Tensor, cx_: &Tensor, reverse: bool, batch_sizes: impl IntList, mode: i64, hidden_size: i64, num_layers: i64, has_biases: bool, bidirectional: bool, batch_first: bool, train: bool
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        self.f_mkldnn_rnn_layer(weight0, weight1, weight2, weight3, hx_, cx_, reverse, batch_sizes, mode, hidden_size, num_layers, has_biases, bidirectional, batch_first, train).unwrap()
    }

    pub fn mkldnn_rnn_layer_backward<T: Borrow<Tensor>>(
        &self, weight1: &Tensor, weight2: &Tensor, weight3: &Tensor, weight4: &Tensor, hx_: &Tensor, cx_tmp: &Tensor, output: &Tensor, hy_: &Tensor, cy_: &Tensor, grad_output: Option<T>, grad_hy: Option<T>, grad_cy: Option<T>, reverse: bool, mode: i64, hidden_size: i64, num_layers: i64, has_biases: bool, train: bool, bidirectional: bool, batch_sizes: impl IntList, batch_first: bool, workspace: &Tensor
    ) -> (Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor) {
        self.f_mkldnn_rnn_layer_backward(weight1, weight2, weight3, weight4, hx_, cx_tmp, output, hy_, cy_, grad_output, grad_hy, grad_cy, reverse, mode, hidden_size, num_layers, has_biases, train, bidirectional, batch_sizes, batch_first, workspace).unwrap()
    }

    pub fn mkldnn_rnn_layer_backward_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, out3: &Tensor, out4: &Tensor, out5: &Tensor, out6: &Tensor, weight1: &Tensor, weight2: &Tensor, weight3: &Tensor, weight4: &Tensor, hx_: &Tensor, cx_tmp: &Tensor, output: &Tensor, hy_: &Tensor, cy_: &Tensor, grad_output: Option<T>, grad_hy: Option<T>, grad_cy: Option<T>, reverse: bool, mode: i64, hidden_size: i64, num_layers: i64, has_biases: bool, train: bool, bidirectional: bool, batch_sizes: impl IntList, batch_first: bool, workspace: &Tensor
    ) -> (Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor) {
        self.f_mkldnn_rnn_layer_backward_out(out0, out1, out2, out3, out4, out5, out6, weight1, weight2, weight3, weight4, hx_, cx_tmp, output, hy_, cy_, grad_output, grad_hy, grad_cy, reverse, mode, hidden_size, num_layers, has_biases, train, bidirectional, batch_sizes, batch_first, workspace).unwrap()
    }

    pub fn mkldnn_rnn_layer_out(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, out3: &Tensor, weight0: &Tensor, weight1: &Tensor, weight2: &Tensor, weight3: &Tensor, hx_: &Tensor, cx_: &Tensor, reverse: bool, batch_sizes: impl IntList, mode: i64, hidden_size: i64, num_layers: i64, has_biases: bool, bidirectional: bool, batch_first: bool, train: bool
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        self.f_mkldnn_rnn_layer_out(out0, out1, out2, out3, weight0, weight1, weight2, weight3, hx_, cx_, reverse, batch_sizes, mode, hidden_size, num_layers, has_biases, bidirectional, batch_first, train).unwrap()
    }
    ...
    pub fn moveaxis(
        &self, source: impl IntList, destination: impl IntList
    ) -> Tensor {
        self.f_moveaxis(source, destination).unwrap()
    }

    pub fn moveaxis_int(
        &self, source: i64, destination: i64
    ) -> Tensor {
    ...
    pub fn g_mul_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_mul_scalar(other).unwrap()
    }

    pub fn g_mul_scalar_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn multi_margin_loss_backward<T: Borrow<Tensor>, S: Into<Scalar>>(
        &self, grad_output: &Tensor, target: &Tensor, p: S, margin: S, weight: Option<T>, reduction: crate::Reduction
    ) -> Tensor {
    ...
    pub fn multi_margin_loss_backward_grad_input<T: Borrow<Tensor>, S: Into<Scalar>>(
        &self, grad_input: &Tensor, grad_output: &Tensor, target: &Tensor, p: S, margin: S, weight: Option<T>, reduction: crate::Reduction
    ) -> Tensor {
        self.f_multi_margin_loss_backward_grad_input(grad_input, grad_output, target, p, margin, weight, reduction).unwrap()
    }
    ...
    pub fn multilabel_margin_loss_backward_grad_input(
        ...
        self.f_multilabel_margin_loss_backward_grad_input(grad_input, grad_output, target, reduction, is_target).unwrap()
    }
    ...
    pub fn multinomial_out(
        &self, out: &Tensor, num_samples: i64, replacement: bool
    ) -> Tensor {
    ...
    pub fn multiply_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_multiply_scalar(other).unwrap()
    }

    pub fn multiply_scalar_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn mvlgamma_out(
        &self, out: &Tensor, p: i64
    ) -> Tensor {
        self.f_mvlgamma_out(out, p).unwrap()
    }

    pub fn nan_to_num(
        &self, nan: impl Into<Option<f64>>, posinf: impl Into<Option<f64>>, neginf: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_nan_to_num(nan, posinf, neginf).unwrap()
    }

    pub fn nan_to_num_(
        &mut self, nan: impl Into<Option<f64>>, posinf: impl Into<Option<f64>>, neginf: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_nan_to_num_(nan, posinf, neginf).unwrap()
    }

    pub fn nan_to_num_out(
        &self, out: &Tensor, nan: impl Into<Option<f64>>, posinf: impl Into<Option<f64>>, neginf: impl Into<Option<f64>>
    ) -> Tensor {
    ...
    pub fn nanquantile(
        &self, q: &Tensor, dim: impl Into<Option<i64>>, keepdim: bool, interpolation: &str
    ) -> Tensor {
        self.f_nanquantile(q, dim, keepdim, interpolation).unwrap()
    }

    pub fn nanquantile_out(
        &self, out: &Tensor, q: &Tensor, dim: impl Into<Option<i64>>, keepdim: bool, interpolation: &str
    ) -> Tensor {
        self.f_nanquantile_out(out, q, dim, keepdim, interpolation).unwrap()
    }

    pub fn nanquantile_scalar(
        &self, q: f64, dim: impl Into<Option<i64>>, keepdim: bool, interpolation: &str
    ) -> Tensor {
        self.f_nanquantile_scalar(q, dim, keepdim, interpolation).unwrap()
    }

    pub fn nanquantile_scalar_out(
        &self, out: &Tensor, q: f64, dim: impl Into<Option<i64>>, keepdim: bool, interpolation: &str
    ) -> Tensor {
    ...
    pub fn narrow_copy_out(
        &self, out: &Tensor, dim: i64, start: i64, length: i64
    ) -> Tensor {
        self.f_narrow_copy_out(out, dim, start, length).unwrap()
    }

    pub fn narrow_tensor(
        &self, dim: i64, start: &Tensor, length: i64
    ) -> Tensor {
    ...
    pub fn native_batch_norm_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, save_mean: &Tensor, save_invstd: &Tensor, weight: Option<T>, bias: Option<T>, running_mean: Option<T>, running_var: Option<T>, training: bool, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor) {
        self.f_native_batch_norm_out(out, save_mean, save_invstd, weight, bias, running_mean, running_var, training, momentum, eps).unwrap()
    }

    pub fn native_channel_shuffle(
        &self, groups: i64
    ) -> Tensor {
        self.f_native_channel_shuffle(groups).unwrap()
    }

    pub fn native_dropout(
        &self, p: f64, train: bool
    ) -> (Tensor, Tensor) {
    ...
    pub fn native_norm_scalaropt_dim_dtype<S: Into<Scalar>>(
        &self, p: S, dim: impl IntList, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
    ...
    pub fn native_norm_scalaropt_dim_dtype_out<S: Into<Scalar>>(
        &self, out: &Tensor, p: S, dim: impl IntList, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
    ...
    pub fn nested_to_padded_tensor(
        &self, padding: f64, output_size: impl IntListOption
    ) -> Tensor {
        self.f_nested_to_padded_tensor(padding, output_size).unwrap()
    }

    pub fn new_empty(
        &self, size: impl IntList, options: (Kind, Device)
    ) -> Tensor {
        self.f_new_empty(size, options).unwrap()
    }

    pub fn new_empty_out(
        &self, out: &Tensor, size: impl IntList
    ) -> Tensor {
    ...
    pub fn new_empty_strided(
        &self, size: impl IntList, stride: impl IntList, options: (Kind, Device)
    ) -> Tensor {
    ...
    pub fn new_full<S: Into<Scalar>>(
        &self, size: impl IntList, fill_value: S, options: (Kind, Device)
    ) -> Tensor {
        self.f_new_full(size, fill_value, options).unwrap()
    }

    pub fn new_full_out<S: Into<Scalar>>(
        &self, out: &Tensor, size: impl IntList, fill_value: S
    ) -> Tensor {
    ...
    pub fn nll_loss2d_backward_grad_input<T: Borrow<Tensor>>(
        ...
        self.f_nll_loss2d_backward_grad_input(grad_input, grad_output, target, weight, reduction, ignore_index, total_weight).unwrap()
    }
    ...
    pub fn nll_loss_backward_grad_input<T: Borrow<Tensor>>(
        ...
        self.f_nll_loss_backward_grad_input(grad_input, grad_output, target, weight, reduction, ignore_index, total_weight).unwrap()
    }
    ...
    pub fn nonzero_static(
        &self, size: i64, fill_value: i64
    ) -> Tensor {
        self.f_nonzero_static(size, fill_value).unwrap()
    }

    pub fn nonzero_static_out(
        &self, out: &Tensor, size: i64, fill_value: i64
    ) -> Tensor {
    ...
    pub fn norm_dtype_out<S: Into<Scalar>>(
        &self, out: &Tensor, p: S, dim: impl IntList, keepdim: bool, dtype: Kind
    ) -> Tensor {
    ...
    pub fn norm_out<S: Into<Scalar>>(
        &self, out: &Tensor, p: S, dim: impl IntList, keepdim: bool
    ) -> Tensor {
        self.f_norm_out(out, p, dim, keepdim).unwrap()
    }

    pub fn norm_scalar_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn norm_scalaropt_dtype_out<S: Into<Scalar>>(
        &self, out: &Tensor, p: S, dtype: Kind
    ) -> Tensor {
    ...
    pub fn normal_functional(
        &self, mean: f64, std: f64
    ) -> Tensor {
        self.f_normal_functional(mean, std).unwrap()
    }

    pub fn not_equal<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_not_equal(other).unwrap()
    }

    pub fn not_equal_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn not_equal_tensor(
        &self, other: &Tensor
    ) -> Tensor {
        self.f_not_equal_tensor(other).unwrap()
    }

    pub fn not_equal_tensor_(
        &mut self, other: &Tensor
    ) -> Tensor {
        self.f_not_equal_tensor_(other).unwrap()
    }

    pub fn not_equal_tensor_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
    ...
    pub fn ormqr_out(
        &self, out: &Tensor, input2: &Tensor, input3: &Tensor, left: bool, transpose: bool
    ) -> Tensor {
    ...
    pub fn pad(
        &self, pad: impl IntList, mode: &str, value: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_pad(pad, mode, value).unwrap()
    }

    pub fn pad_sequence<T: Borrow<Tensor>>(
        sequences: &[T], batch_first: bool, padding_value: f64
    ) -> Tensor {
    ...
    pub fn poisson_nll_loss(
        &self, target: &Tensor, log_input: bool, full: bool, eps: f64, reduction: crate::Reduction
    ) -> Tensor {
    ...
    pub fn polar_out(
        out: &Tensor, abs: &Tensor, angle: &Tensor
    ) -> Tensor {
    ...
    pub fn pow_tensor_scalar<S: Into<Scalar>>(
        &self, exponent: S
    ) -> Tensor {
    ...
    pub fn prod_dim_int(
        &self, dim: i64, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
        self.f_prod_dim_int(dim, keepdim, dtype).unwrap()
    }

    pub fn prod_int_out(
        &self, out: &Tensor, dim: i64, keepdim: bool, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
        self.f_prod_int_out(out, dim, keepdim, dtype).unwrap()
    }

    pub fn prod_out(
        &self, out: &Tensor, dtype: impl Into<Option<Kind>>
    ) -> Tensor {
    ...
    pub fn put_(
        &mut self, index: &Tensor, source: &Tensor, accumulate: bool
    ) -> Tensor {
        self.f_put_(index, source, accumulate).unwrap()
    }

    pub fn put_out(
        &self, out: &Tensor, index: &Tensor, source: &Tensor, accumulate: bool
    ) -> Tensor {
        self.f_put_out(out, index, source, accumulate).unwrap()
    }

    pub fn q_per_channel_axis(
        &self, 
    ) -> i64 {
        self.f_q_per_channel_axis().unwrap()
    }

    pub fn q_per_channel_scales(
        &self, 
    ) -> Tensor {
        self.f_q_per_channel_scales().unwrap()
    }

    pub fn q_per_channel_scales_out(
        &self, out: &Tensor
    ) -> Tensor {
        self.f_q_per_channel_scales_out(out).unwrap()
    }

    pub fn q_per_channel_zero_points(
        &self, 
    ) -> Tensor {
        self.f_q_per_channel_zero_points().unwrap()
    }

    pub fn q_per_channel_zero_points_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn qr_q(
        &self, q: &Tensor, r: &Tensor, some: bool
    ) -> (Tensor, Tensor) {
    ...
    pub fn quantize_per_tensor_tensors<T: Borrow<Tensor>>(
        tensors: &[T], scales: &Tensor, zero_points: &Tensor, dtype: Kind
    ) -> Vec<Tensor> {
    ...
    pub fn quantize_per_tensor_tensors_out<T: Borrow<Tensor>>(
        out: &[T], tensors: &[T], scales: &Tensor, zero_points: &Tensor, dtype: Kind
    ) {
    ...
    pub fn quantized_batch_norm<T: Borrow<Tensor>>(
        &self, weight: Option<T>, bias: Option<T>, mean: &Tensor, var: &Tensor, eps: f64, output_scale: f64, output_zero_point: i64
    ) -> Tensor {
        self.f_quantized_batch_norm(weight, bias, mean, var, eps, output_scale, output_zero_point).unwrap()
    }

    pub fn quantized_batch_norm_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: Option<T>, bias: Option<T>, mean: &Tensor, var: &Tensor, eps: f64, output_scale: f64, output_zero_point: i64
    ) -> Tensor {
        self.f_quantized_batch_norm_out(out, weight, bias, mean, var, eps, output_scale, output_zero_point).unwrap()
    }

    pub fn quantized_gru_cell<S: Into<Scalar>>(
        &self, hx: &Tensor, w_ih: &Tensor, w_hh: &Tensor, b_ih: &Tensor, b_hh: &Tensor, packed_ih: &Tensor, packed_hh: &Tensor, col_offsets_ih: &Tensor, col_offsets_hh: &Tensor, scale_ih: S, scale_hh: S, zero_point_ih: S, zero_point_hh: S
    ) -> Tensor {
        self.f_quantized_gru_cell(hx, w_ih, w_hh, b_ih, b_hh, packed_ih, packed_hh, col_offsets_ih, col_offsets_hh, scale_ih, scale_hh, zero_point_ih, zero_point_hh).unwrap()
    }

    pub fn quantized_lstm_cell<T: Borrow<Tensor>, S: Into<Scalar>>(
        &self, hx: &[T], w_ih: &Tensor, w_hh: &Tensor, b_ih: &Tensor, b_hh: &Tensor, packed_ih: &Tensor, packed_hh: &Tensor, col_offsets_ih: &Tensor, col_offsets_hh: &Tensor, scale_ih: S, scale_hh: S, zero_point_ih: S, zero_point_hh: S
    ) -> (Tensor, Tensor) {
        self.f_quantized_lstm_cell(hx, w_ih, w_hh, b_ih, b_hh, packed_ih, packed_hh, col_offsets_ih, col_offsets_hh, scale_ih, scale_hh, zero_point_ih, zero_point_hh).unwrap()
    }
    ...
    pub fn quantized_max_pool1d_out(
        ...
        self.f_quantized_max_pool1d_out(out, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }
    ...
    pub fn quantized_max_pool2d_out(
        ...
        self.f_quantized_max_pool2d_out(out, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }
    ...
    pub fn quantized_max_pool3d_out(
        ...
        self.f_quantized_max_pool3d_out(out, kernel_size, stride, padding, dilation, ceil_mode).unwrap()
    }

    pub fn quantized_rnn_relu_cell<S: Into<Scalar>>(
        &self, hx: &Tensor, w_ih: &Tensor, w_hh: &Tensor, b_ih: &Tensor, b_hh: &Tensor, packed_ih: &Tensor, packed_hh: &Tensor, col_offsets_ih: &Tensor, col_offsets_hh: &Tensor, scale_ih: S, scale_hh: S, zero_point_ih: S, zero_point_hh: S
    ) -> Tensor {
        self.f_quantized_rnn_relu_cell(hx, w_ih, w_hh, b_ih, b_hh, packed_ih, packed_hh, col_offsets_ih, col_offsets_hh, scale_ih, scale_hh, zero_point_ih, zero_point_hh).unwrap()
    }

    pub fn quantized_rnn_tanh_cell<S: Into<Scalar>>(
        &self, hx: &Tensor, w_ih: &Tensor, w_hh: &Tensor, b_ih: &Tensor, b_hh: &Tensor, packed_ih: &Tensor, packed_hh: &Tensor, col_offsets_ih: &Tensor, col_offsets_hh: &Tensor, scale_ih: S, scale_hh: S, zero_point_ih: S, zero_point_hh: S
    ) -> Tensor {
        self.f_quantized_rnn_tanh_cell(hx, w_ih, w_hh, b_ih, b_hh, packed_ih, packed_hh, col_offsets_ih, col_offsets_hh, scale_ih, scale_hh, zero_point_ih, zero_point_hh).unwrap()
    }
    ...
    pub fn randint(
        high: i64, size: impl IntList, options: (Kind, Device)
    ) -> Tensor {
    ...
    pub fn randint_like_low_dtype_out(
        &self, out: &Tensor, low: i64, high: i64
    ) -> Tensor {
        self.f_randint_like_low_dtype_out(out, low, high).unwrap()
    }

    pub fn randint_like_out(
        &self, out: &Tensor, high: i64
    ) -> Tensor {
        self.f_randint_like_out(out, high).unwrap()
    }

    pub fn randint_low(
        low: i64, high: i64, size: impl IntList, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_randint_low(low, high, size, options).unwrap()
    }

    pub fn randint_low_out(
        out: &Tensor, low: i64, high: i64, size: impl IntList
    ) -> Tensor {
        Tensor::f_randint_low_out(out, low, high, size).unwrap()
    }

    pub fn randint_out(
        out: &Tensor, high: i64, size: impl IntList
    ) -> Tensor {
    ...
    pub fn random_from(
        &self, from: i64, to: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_random_from(from, to).unwrap()
    }

    pub fn random_from_(
        &mut self, from: i64, to: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_random_from_(from, to).unwrap()
    }

    pub fn random_from_out(
        &self, out: &Tensor, from: i64, to: impl Into<Option<i64>>
    ) -> Tensor {
    ...
    pub fn random_to_out(
        &self, out: &Tensor, to: i64
    ) -> Tensor {
    ...
    pub fn range_out<S: Into<Scalar>>(
        out: &Tensor, start: S, end: S
    ) -> Tensor {
        Tensor::f_range_out(out, start, end).unwrap()
    }

    pub fn range_out_<S: Into<Scalar>>(
        out: &Tensor, start: S, end: S
    ) -> Tensor {
    ...
    pub fn remainder_tensor_(
        &mut self, other: &Tensor
    ) -> Tensor {
        self.f_remainder_tensor_(other).unwrap()
    }

    pub fn remainder_tensor_out(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
    ...
    pub fn requires_grad_(
        &mut self, requires_grad: bool
    ) -> Tensor {
    ...
    pub fn resize_as_(
        &mut self, the_template: &Tensor
    ) -> Tensor {
        self.f_resize_as_(the_template).unwrap()
    }

    pub fn resize_as_out(
        &self, out: &Tensor, the_template: &Tensor
    ) -> Tensor {
    ...
    pub fn rnn_relu_data<T: Borrow<Tensor>>(
        ...
        Tensor::f_rnn_relu_data(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional).unwrap()
    }
    ...
    pub fn rnn_tanh_data<T: Borrow<Tensor>>(
        ...
        Tensor::f_rnn_tanh_data(data, batch_sizes, hx, params, has_biases, num_layers, dropout, train, bidirectional).unwrap()
    }

    pub fn roll(
        &self, shifts: impl IntList, dims: impl IntList
    ) -> Tensor {
        self.f_roll(shifts, dims).unwrap()
    }

    pub fn roll_out(
        &self, out: &Tensor, shifts: impl IntList, dims: impl IntList
    ) -> Tensor {
        self.f_roll_out(out, shifts, dims).unwrap()
    }

    pub fn rot90(
        &self, k: i64, dims: impl IntList
    ) -> Tensor {
        self.f_rot90(k, dims).unwrap()
    }

    pub fn rot90_out(
        &self, out: &Tensor, k: i64, dims: impl IntList
    ) -> Tensor {
    ...
    pub fn round_decimals_(
        &mut self, decimals: i64
    ) -> Tensor {
        self.f_round_decimals_(decimals).unwrap()
    }

    pub fn round_decimals_out(
        &self, out: &Tensor, decimals: i64
    ) -> Tensor {
    ...
    pub fn row_indices_copy(
        &self, 
    ) -> Tensor {
        self.f_row_indices_copy().unwrap()
    }

    pub fn row_indices_copy_out(
        &self, out: &Tensor
    ) -> Tensor {
        self.f_row_indices_copy_out(out).unwrap()
    }

    pub fn row_stack<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Tensor {
    ...
    pub fn rrelu_with_noise_(
        &mut self, noise: &Tensor, training: bool
    ) -> Tensor {
        self.f_rrelu_with_noise_(noise, training).unwrap()
    }

    pub fn rrelu_with_noise_backward<S: Into<Scalar>>(
        &self, grad_output: &Tensor, noise: &Tensor, lower: S, upper: S, training: bool, self_is_result: bool
    ) -> Tensor {
        self.f_rrelu_with_noise_backward(grad_output, noise, lower, upper, training, self_is_result).unwrap()
    }

    pub fn rrelu_with_noise_backward_out<S: Into<Scalar>>(
        &self, out: &Tensor, grad_output: &Tensor, noise: &Tensor, lower: S, upper: S, training: bool, self_is_result: bool
    ) -> Tensor {
        self.f_rrelu_with_noise_backward_out(out, grad_output, noise, lower, upper, training, self_is_result).unwrap()
    }

    pub fn rrelu_with_noise_out(
        &self, out: &Tensor, noise: &Tensor, training: bool
    ) -> Tensor {
    ...
    pub fn rsub_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
    ...
    pub fn scalar_tensor<S: Into<Scalar>>(
        s: S, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_scalar_tensor(s, options).unwrap()
    }

    pub fn scalar_tensor_out<S: Into<Scalar>>(
        out: &Tensor, s: S
    ) -> Tensor {
    ...
    pub fn scaled_dot_product_attention<T: Borrow<Tensor>>(
        ...
        Tensor::f_scaled_dot_product_attention(query, key, value, attn_mask, dropout_p, is_causal, scale).unwrap()
    }
    ...
    pub fn scatter_(
        &mut self, dim: i64, index: &Tensor, src: &Tensor
    ) -> Tensor {
    ...
    pub fn searchsorted_scalar<T: Borrow<Tensor>, S: Into<Scalar>>(
        sorted_sequence: &Tensor, self_scalar: S, out_int32: bool, right: bool, side: &str, sorter: Option<T>
    ) -> Tensor {
        Tensor::f_searchsorted_scalar(sorted_sequence, self_scalar, out_int32, right, side, sorter).unwrap()
    }

    pub fn searchsorted_scalar_out<T: Borrow<Tensor>, S: Into<Scalar>>(
        out: &Tensor, sorted_sequence: &Tensor, self_scalar: S, out_int32: bool, right: bool, side: &str, sorter: Option<T>
    ) -> Tensor {
        Tensor::f_searchsorted_scalar_out(out, sorted_sequence, self_scalar, out_int32, right, side, sorter).unwrap()
    }

    pub fn searchsorted_tensor_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, sorted_sequence: &Tensor, out_int32: bool, right: bool, side: &str, sorter: Option<T>
    ) -> Tensor {
        self.f_searchsorted_tensor_out(out, sorted_sequence, out_int32, right, side, sorter).unwrap()
    }

    pub fn segment_reduce<T: Borrow<Tensor>, S: Into<Scalar>>(
        data: &Tensor, reduce: &str, lengths: Option<T>, indices: Option<T>, offsets: Option<T>, axis: i64, unsafe_: bool, initial: S
    ) -> Tensor {
        Tensor::f_segment_reduce(data, reduce, lengths, indices, offsets, axis, unsafe_, initial).unwrap()
    }

    pub fn segment_reduce_out<T: Borrow<Tensor>, S: Into<Scalar>>(
        out: &Tensor, data: &Tensor, reduce: &str, lengths: Option<T>, indices: Option<T>, offsets: Option<T>, axis: i64, unsafe_: bool, initial: S
    ) -> Tensor {
        Tensor::f_segment_reduce_out(out, data, reduce, lengths, indices, offsets, axis, unsafe_, initial).unwrap()
    }
    ...
    pub fn select_backward(
        grad_output: &Tensor, input_sizes: impl IntList, dim: i64, index: i64
    ) -> Tensor {
        Tensor::f_select_backward(grad_output, input_sizes, dim, index).unwrap()
    }

    pub fn select_backward_out(
        out: &Tensor, grad_output: &Tensor, input_sizes: impl IntList, dim: i64, index: i64
    ) -> Tensor {
    ...
    pub fn set_source_tensor(
        &self, source: &Tensor
    ) -> Tensor {
        self.f_set_source_tensor(source).unwrap()
    }

    pub fn set_source_tensor_(
        &mut self, source: &Tensor
    ) -> Tensor {
        self.f_set_source_tensor_(source).unwrap()
    }

    pub fn set_source_tensor_out(
        &self, out: &Tensor, source: &Tensor
    ) -> Tensor {
        self.f_set_source_tensor_out(out, source).unwrap()
    }

    pub fn set_source_tensor_storage_offset_(
        &mut self, source: &Tensor, storage_offset: i64, size: impl IntList, stride: impl IntList
    ) -> Tensor {
    ...
    pub fn slice(
        &self, dim: i64, start: impl Into<Option<i64>>, end: impl Into<Option<i64>>, step: i64
    ) -> Tensor {
        self.f_slice(dim, start, end, step).unwrap()
    }

    pub fn slice_backward(
        grad_output: &Tensor, input_sizes: impl IntList, dim: i64, start: i64, end: i64, step: i64
    ) -> Tensor {
        Tensor::f_slice_backward(grad_output, input_sizes, dim, start, end, step).unwrap()
    }

    pub fn slice_backward_out(
        out: &Tensor, grad_output: &Tensor, input_sizes: impl IntList, dim: i64, start: i64, end: i64, step: i64
    ) -> Tensor {
    ...
    pub fn slice_copy_tensor_out(
        &self, out: &Tensor, dim: i64, start: impl Into<Option<i64>>, end: impl Into<Option<i64>>, step: i64
    ) -> Tensor {
        self.f_slice_copy_tensor_out(out, dim, start, end, step).unwrap()
    }

    pub fn slice_scatter(
        &self, src: &Tensor, dim: i64, start: impl Into<Option<i64>>, end: impl Into<Option<i64>>, step: i64
    ) -> Tensor {
        self.f_slice_scatter(src, dim, start, end, step).unwrap()
    }

    pub fn slice_scatter_out(
        &self, out: &Tensor, src: &Tensor, dim: i64, start: impl Into<Option<i64>>, end: impl Into<Option<i64>>, step: i64
    ) -> Tensor {
    ...
    pub fn slogdet_out(
        &self, sign: &Tensor, logabsdet: &Tensor
    ) -> (Tensor, Tensor) {
        self.f_slogdet_out(sign, logabsdet).unwrap()
    }

    pub fn slow_conv3d<T: Borrow<Tensor>>(
        &self, weight: &Tensor, kernel_size: impl IntList, bias: Option<T>, stride: impl IntList, padding: impl IntList
    ) -> Tensor {
        self.f_slow_conv3d(weight, kernel_size, bias, stride, padding).unwrap()
    }

    pub fn slow_conv3d_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, kernel_size: impl IntList, bias: Option<T>, stride: impl IntList, padding: impl IntList
    ) -> Tensor {
    ...
    pub fn slow_conv_dilated2d_out<T: Borrow<Tensor>>(
        ...
        self.f_slow_conv_dilated2d_out(out, weight, kernel_size, bias, stride, padding, dilation).unwrap()
    }
    ...
    pub fn slow_conv_dilated3d_out<T: Borrow<Tensor>>(
        ...
        self.f_slow_conv_dilated3d_out(out, weight, kernel_size, bias, stride, padding, dilation).unwrap()
    }

    pub fn slow_conv_transpose2d<T: Borrow<Tensor>>(
        &self, weight: &Tensor, kernel_size: impl IntList, bias: Option<T>, stride: impl IntList, padding: impl IntList, output_padding: impl IntList, dilation: impl IntList
    ) -> Tensor {
        self.f_slow_conv_transpose2d(weight, kernel_size, bias, stride, padding, output_padding, dilation).unwrap()
    }

    pub fn slow_conv_transpose2d_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, kernel_size: impl IntList, bias: Option<T>, stride: impl IntList, padding: impl IntList, output_padding: impl IntList, dilation: impl IntList
    ) -> Tensor {
        self.f_slow_conv_transpose2d_out(out, weight, kernel_size, bias, stride, padding, output_padding, dilation).unwrap()
    }

    pub fn slow_conv_transpose3d<T: Borrow<Tensor>>(
        &self, weight: &Tensor, kernel_size: impl IntList, bias: Option<T>, stride: impl IntList, padding: impl IntList, output_padding: impl IntList, dilation: impl IntList
    ) -> Tensor {
        self.f_slow_conv_transpose3d(weight, kernel_size, bias, stride, padding, output_padding, dilation).unwrap()
    }

    pub fn slow_conv_transpose3d_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, weight: &Tensor, kernel_size: impl IntList, bias: Option<T>, stride: impl IntList, padding: impl IntList, output_padding: impl IntList, dilation: impl IntList
    ) -> Tensor {
        self.f_slow_conv_transpose3d_out(out, weight, kernel_size, bias, stride, padding, output_padding, dilation).unwrap()
    }
    ...
    pub fn smooth_l1_loss(
        &self, target: &Tensor, reduction: crate::Reduction, beta: f64
    ) -> Tensor {
        self.f_smooth_l1_loss(target, reduction, beta).unwrap()
    }

    pub fn smooth_l1_loss_backward(
        &self, grad_output: &Tensor, target: &Tensor, reduction: crate::Reduction, beta: f64
    ) -> Tensor {
        self.f_smooth_l1_loss_backward(grad_output, target, reduction, beta).unwrap()
    }

    pub fn smooth_l1_loss_backward_grad_input(
        &self, grad_input: &Tensor, grad_output: &Tensor, target: &Tensor, reduction: crate::Reduction, beta: f64
    ) -> Tensor {
        self.f_smooth_l1_loss_backward_grad_input(grad_input, grad_output, target, reduction, beta).unwrap()
    }

    pub fn smooth_l1_loss_out(
        &self, out: &Tensor, target: &Tensor, reduction: crate::Reduction, beta: f64
    ) -> Tensor {
    ...
    pub fn soft_margin_loss_backward_grad_input(
        ...
        self.f_soft_margin_loss_backward_grad_input(grad_input, grad_output, target, reduction).unwrap()
    }
    ...
    pub fn sort_values_stable(
        &self, values: &Tensor, indices: &Tensor, stable: bool, dim: i64, descending: bool
    ) -> (Tensor, Tensor) {
        self.f_sort_values_stable(values, indices, stable, dim, descending).unwrap()
    }

    pub fn sparse_bsc_tensor(
        ccol_indices: &Tensor, row_indices: &Tensor, values: &Tensor, options: (Kind, Device)
    ) -> Tensor {
    ...
    pub fn sparse_bsc_tensor_ccol_row_value_size(
        ...
        Tensor::f_sparse_bsc_tensor_ccol_row_value_size(ccol_indices, row_indices, values, size, options).unwrap()
    }

    pub fn sparse_bsr_tensor(
        crow_indices: &Tensor, col_indices: &Tensor, values: &Tensor, options: (Kind, Device)
    ) -> Tensor {
    ...
    pub fn sparse_bsr_tensor_crow_col_value_size(
        ...
        Tensor::f_sparse_bsr_tensor_crow_col_value_size(crow_indices, col_indices, values, size, options).unwrap()
    }

    pub fn sparse_compressed_tensor(
        compressed_indices: &Tensor, plain_indices: &Tensor, values: &Tensor, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_sparse_compressed_tensor(compressed_indices, plain_indices, values, options).unwrap()
    }

    pub fn sparse_compressed_tensor_comp_plain_value_size(
        compressed_indices: &Tensor, plain_indices: &Tensor, values: &Tensor, size: impl IntList, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_sparse_compressed_tensor_comp_plain_value_size(compressed_indices, plain_indices, values, size, options).unwrap()
    }
    ...
    pub fn sparse_coo_tensor_indices(
        indices: &Tensor, values: &Tensor, options: (Kind, Device), is_coalesced: bool
    ) -> Tensor {
    ...
    pub fn sparse_coo_tensor_indices_size(
        ...
        Tensor::f_sparse_coo_tensor_indices_size(indices, values, size, options, is_coalesced).unwrap()
    }
    ...
    pub fn sparse_csc_tensor_ccol_row_value_size(
        ...
        Tensor::f_sparse_csc_tensor_ccol_row_value_size(ccol_indices, row_indices, values, size, options).unwrap()
    }
    ...
    pub fn sparse_csr_tensor_crow_col_value_size(
        ...
        Tensor::f_sparse_csr_tensor_crow_col_value_size(crow_indices, col_indices, values, size, options).unwrap()
    }
    ...
    pub fn sparse_resize(
        &self, size: impl IntList, sparse_dim: i64, dense_dim: i64
    ) -> Tensor {
        self.f_sparse_resize(size, sparse_dim, dense_dim).unwrap()
    }

    pub fn sparse_resize_(
        &mut self, size: impl IntList, sparse_dim: i64, dense_dim: i64
    ) -> Tensor {
    ...
    pub fn sparse_resize_and_clear_out(
        &self, out: &Tensor, size: impl IntList, sparse_dim: i64, dense_dim: i64
    ) -> Tensor {
    ...
    pub fn special_chebyshev_polynomial_v(
        x: &Tensor, n: &Tensor
    ) -> Tensor {
    ...
    pub fn special_chebyshev_polynomial_w(
        x: &Tensor, n: &Tensor
    ) -> Tensor {
    ...
    pub fn special_digamma(
        &self, 
    ) -> Tensor {
        self.f_special_digamma().unwrap()
    }

    pub fn special_digamma_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn special_hermite_polynomial_he(
        x: &Tensor, n: &Tensor
    ) -> Tensor {
    ...
    pub fn special_i1e_out(
        &self, out: &Tensor
    ) -> Tensor {
        self.f_special_i1e_out(out).unwrap()
    }

    pub fn special_laguerre_polynomial_l(
        x: &Tensor, n: &Tensor
    ) -> Tensor {
    ...
    pub fn special_legendre_polynomial_p(
        x: &Tensor, n: &Tensor
    ) -> Tensor {
    ...
    pub fn special_log1p(
        &self, 
    ) -> Tensor {
        self.f_special_log1p().unwrap()
    }

    pub fn special_log1p_out(
        &self, out: &Tensor
    ) -> Tensor {
        self.f_special_log1p_out(out).unwrap()
    }

    pub fn special_log_ndtr(
        &self, 
    ) -> Tensor {
        self.f_special_log_ndtr().unwrap()
    }

    pub fn special_log_ndtr_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn special_scaled_modified_bessel_k1(
        x: &Tensor
    ) -> Tensor {
    ...
    pub fn special_zeta_other_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
    ...
    pub fn split_copy_tensor_out<T: Borrow<Tensor>>(
        &self, out: &[T], split_size: i64, dim: i64
    ) {
        self.f_split_copy_tensor_out(out, split_size, dim).unwrap()
    }

    pub fn split_sizes(
        &self, split_size: impl IntList, dim: i64
    ) -> Vec<Tensor> {
        self.f_split_sizes(split_size, dim).unwrap()
    }

    pub fn split_with_sizes(
        &self, split_sizes: impl IntList, dim: i64
    ) -> Vec<Tensor> {
    ...
    pub fn split_with_sizes_copy_out<T: Borrow<Tensor>>(
        &self, out: &[T], split_sizes: impl IntList, dim: i64
    ) {
    ...
    pub fn squeeze_dims_(
        &mut self, dim: impl IntList
    ) -> Tensor {
    ...
    pub fn std_correction<S: Into<Scalar>>(
        &self, dim: impl IntListOption, correction: S, keepdim: bool
    ) -> Tensor {
        self.f_std_correction(dim, correction, keepdim).unwrap()
    }

    pub fn std_correction_out<S: Into<Scalar>>(
        &self, out: &Tensor, dim: impl IntListOption, correction: S, keepdim: bool
    ) -> Tensor {
        self.f_std_correction_out(out, dim, correction, keepdim).unwrap()
    }

    pub fn std_dim(
        &self, dim: impl IntListOption, unbiased: bool, keepdim: bool
    ) -> Tensor {
    ...
    pub fn std_mean_correction_out<S: Into<Scalar>>(
        &self, out0: &Tensor, out1: &Tensor, dim: impl IntListOption, correction: S, keepdim: bool
    ) -> (Tensor, Tensor) {
    ...
    pub fn std_out(
        &self, out: &Tensor, dim: impl IntListOption, unbiased: bool, keepdim: bool
    ) -> Tensor {
        self.f_std_out(out, dim, unbiased, keepdim).unwrap()
    }

    pub fn stft<T: Borrow<Tensor>>(
        &self, n_fft: i64, hop_length: impl Into<Option<i64>>, win_length: impl Into<Option<i64>>, window: Option<T>, normalized: bool, onesided: bool, return_complex: bool
    ) -> Tensor {
        self.f_stft(n_fft, hop_length, win_length, window, normalized, onesided, return_complex).unwrap()
    }

    pub fn stft_center<T: Borrow<Tensor>>(
        &self, n_fft: i64, hop_length: impl Into<Option<i64>>, win_length: impl Into<Option<i64>>, window: Option<T>, center: bool, pad_mode: &str, normalized: bool, onesided: bool, return_complex: bool
    ) -> Tensor {
        self.f_stft_center(n_fft, hop_length, win_length, window, center, pad_mode, normalized, onesided, return_complex).unwrap()
    }
    ...
    pub fn g_sub_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_sub_scalar(other).unwrap()
    }

    pub fn g_sub_scalar_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn subtract_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_subtract_scalar(other).unwrap()
    }

    pub fn subtract_scalar_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn swapaxes(
        &self, axis0: i64, axis1: i64
    ) -> Tensor {
        self.f_swapaxes(axis0, axis1).unwrap()
    }

    pub fn swapaxes_(
        &mut self, axis0: i64, axis1: i64
    ) -> Tensor {
    ...
    pub fn take_along_dim(
        &self, indices: &Tensor, dim: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_take_along_dim(indices, dim).unwrap()
    }

    pub fn take_along_dim_out(
        &self, out: &Tensor, indices: &Tensor, dim: impl Into<Option<i64>>
    ) -> Tensor {
        self.f_take_along_dim_out(out, indices, dim).unwrap()
    }

    pub fn take_out(
        &self, out: &Tensor, index: &Tensor
    ) -> Tensor {
    ...
    pub fn to_dense_backward(
        &self, grad: &Tensor, masked_grad: bool
    ) -> Tensor {
    ...
    pub fn to_padded_tensor_out(
        &self, out: &Tensor, padding: f64, output_size: impl IntListOption
    ) -> Tensor {
    ...
    pub fn trace_backward(
        grad: &Tensor, sizes: impl IntList
    ) -> Tensor {
    ...
    pub fn tril_(
        &mut self, diagonal: i64
    ) -> Tensor {
        self.f_tril_(diagonal).unwrap()
    }

    pub fn tril_indices(
        row: i64, col: i64, offset: i64, options: (Kind, Device)
    ) -> Tensor {
    ...
    pub fn true_divide_scalar<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_true_divide_scalar(other).unwrap()
    }

    pub fn true_divide_scalar_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
    ...
    pub fn unfold_backward(
        grad_in: &Tensor, input_sizes: impl IntList, dim: i64, size: i64, step: i64
    ) -> Tensor {
        Tensor::f_unfold_backward(grad_in, input_sizes, dim, size, step).unwrap()
    }

    pub fn unfold_backward_out(
        out: &Tensor, grad_in: &Tensor, input_sizes: impl IntList, dim: i64, size: i64, step: i64
    ) -> Tensor {
    ...
    pub fn unfold_copy_out(
        &self, out: &Tensor, dimension: i64, size: i64, step: i64
    ) -> Tensor {
    ...
    pub fn uniform_(
        &mut self, from: f64, to: f64
    ) -> Tensor {
        self.f_uniform_(from, to).unwrap()
    }

    pub fn uniform_out(
        &self, out: &Tensor, from: f64, to: f64
    ) -> Tensor {
        self.f_uniform_out(out, from, to).unwrap()
    }

    pub fn unique_consecutive(
        &self, return_inverse: bool, return_counts: bool, dim: impl Into<Option<i64>>
    ) -> (Tensor, Tensor, Tensor) {
        self.f_unique_consecutive(return_inverse, return_counts, dim).unwrap()
    }

    pub fn unique_consecutive_out(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, return_inverse: bool, return_counts: bool, dim: impl Into<Option<i64>>
    ) -> (Tensor, Tensor, Tensor) {
        self.f_unique_consecutive_out(out0, out1, out2, return_inverse, return_counts, dim).unwrap()
    }

    pub fn unique_dim(
        &self, dim: i64, sorted: bool, return_inverse: bool, return_counts: bool
    ) -> (Tensor, Tensor, Tensor) {
        self.f_unique_dim(dim, sorted, return_inverse, return_counts).unwrap()
    }

    pub fn unique_dim_consecutive(
        &self, dim: i64, return_inverse: bool, return_counts: bool
    ) -> (Tensor, Tensor, Tensor) {
        self.f_unique_dim_consecutive(dim, return_inverse, return_counts).unwrap()
    }

    pub fn unique_dim_consecutive_out(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, dim: i64, return_inverse: bool, return_counts: bool
    ) -> (Tensor, Tensor, Tensor) {
        self.f_unique_dim_consecutive_out(out0, out1, out2, dim, return_inverse, return_counts).unwrap()
    }

    pub fn unique_dim_out(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, dim: i64, sorted: bool, return_inverse: bool, return_counts: bool
    ) -> (Tensor, Tensor, Tensor) {
    ...
    pub fn unsqueeze_copy(
        &self, dim: i64
    ) -> Tensor {
        self.f_unsqueeze_copy(dim).unwrap()
    }

    pub fn unsqueeze_copy_out(
        &self, out: &Tensor, dim: i64
    ) -> Tensor {
    ...
    pub fn upsample_bicubic2d_backward(
        ...
        Tensor::f_upsample_bicubic2d_backward(grad_output, output_size, input_size, align_corners, scales_h, scales_w).unwrap()
    }

    pub fn upsample_bicubic2d_backward_grad_input(
        grad_input: &Tensor, grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, align_corners: bool, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_upsample_bicubic2d_backward_grad_input(grad_input, grad_output, output_size, input_size, align_corners, scales_h, scales_w).unwrap()
    }
    ...
    pub fn upsample_bilinear2d_backward(
        ...
        Tensor::f_upsample_bilinear2d_backward(grad_output, output_size, input_size, align_corners, scales_h, scales_w).unwrap()
    }

    pub fn upsample_bilinear2d_backward_grad_input(
        grad_input: &Tensor, grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, align_corners: bool, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_upsample_bilinear2d_backward_grad_input(grad_input, grad_output, output_size, input_size, align_corners, scales_h, scales_w).unwrap()
    }
    ...
    pub fn upsample_linear1d(
        &self, output_size: impl IntList, align_corners: bool, scales: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_upsample_linear1d(output_size, align_corners, scales).unwrap()
    }

    pub fn upsample_linear1d_backward(
        grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, align_corners: bool, scales: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_upsample_linear1d_backward(grad_output, output_size, input_size, align_corners, scales).unwrap()
    }

    pub fn upsample_linear1d_backward_grad_input(
        grad_input: &Tensor, grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, align_corners: bool, scales: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_upsample_linear1d_backward_grad_input(grad_input, grad_output, output_size, input_size, align_corners, scales).unwrap()
    }

    pub fn upsample_linear1d_out(
        &self, out: &Tensor, output_size: impl IntList, align_corners: bool, scales: impl Into<Option<f64>>
    ) -> Tensor {
    ...
    pub fn upsample_nearest1d_backward_grad_input(
        ...
        Tensor::f_upsample_nearest1d_backward_grad_input(grad_input, grad_output, output_size, input_size, scales).unwrap()
    }
    ...
    pub fn upsample_nearest2d_backward(
        ...
        Tensor::f_upsample_nearest2d_backward(grad_output, output_size, input_size, scales_h, scales_w).unwrap()
    }

    pub fn upsample_nearest2d_backward_grad_input(
        grad_input: &Tensor, grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_upsample_nearest2d_backward_grad_input(grad_input, grad_output, output_size, input_size, scales_h, scales_w).unwrap()
    }
    ...
    pub fn upsample_nearest3d_backward(
        ...
        Tensor::f_upsample_nearest3d_backward(grad_output, output_size, input_size, scales_d, scales_h, scales_w).unwrap()
    }

    pub fn upsample_nearest3d_backward_grad_input(
        grad_input: &Tensor, grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, scales_d: impl Into<Option<f64>>, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_upsample_nearest3d_backward_grad_input(grad_input, grad_output, output_size, input_size, scales_d, scales_h, scales_w).unwrap()
    }
    ...
    pub fn upsample_trilinear3d(
        &self, output_size: impl IntList, align_corners: bool, scales_d: impl Into<Option<f64>>, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_upsample_trilinear3d(output_size, align_corners, scales_d, scales_h, scales_w).unwrap()
    }

    pub fn upsample_trilinear3d_backward(
        grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, align_corners: bool, scales_d: impl Into<Option<f64>>, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_upsample_trilinear3d_backward(grad_output, output_size, input_size, align_corners, scales_d, scales_h, scales_w).unwrap()
    }

    pub fn upsample_trilinear3d_backward_grad_input(
        grad_input: &Tensor, grad_output: &Tensor, output_size: impl IntList, input_size: impl IntList, align_corners: bool, scales_d: impl Into<Option<f64>>, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        Tensor::f_upsample_trilinear3d_backward_grad_input(grad_input, grad_output, output_size, input_size, align_corners, scales_d, scales_h, scales_w).unwrap()
    }

    pub fn upsample_trilinear3d_out(
        &self, out: &Tensor, output_size: impl IntList, align_corners: bool, scales_d: impl Into<Option<f64>>, scales_h: impl Into<Option<f64>>, scales_w: impl Into<Option<f64>>
    ) -> Tensor {
        self.f_upsample_trilinear3d_out(out, output_size, align_corners, scales_d, scales_h, scales_w).unwrap()
    }
    ...
    pub fn value_selecting_reduction_backward(
        grad: &Tensor, dim: i64, indices: &Tensor, sizes: impl IntList, keepdim: bool
    ) -> Tensor {
    ...
    pub fn vander(
        x: &Tensor, n: impl Into<Option<i64>>, increasing: bool
    ) -> Tensor {
    ...
    pub fn view_as_complex(
        &self, 
    ) -> Tensor {
        self.f_view_as_complex().unwrap()
    }

    pub fn view_as_complex_copy(
        &self, 
    ) -> Tensor {
        self.f_view_as_complex_copy().unwrap()
    }

    pub fn view_as_complex_copy_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn view_as_real_copy(
        &self, 
    ) -> Tensor {
        self.f_view_as_real_copy().unwrap()
    }

    pub fn view_as_real_copy_out(
        &self, out: &Tensor
    ) -> Tensor {
    ...
    pub fn view_copy_dtype(
        &self, dtype: Kind
    ) -> Tensor {
        self.f_view_copy_dtype(dtype).unwrap()
    }

    pub fn view_copy_dtype_out(
        &self, out: &Tensor, dtype: Kind
    ) -> Tensor {
        self.f_view_copy_dtype_out(out, dtype).unwrap()
    }

    pub fn view_copy_out(
        &self, out: &Tensor, size: impl IntList
    ) -> Tensor {
    ...
    pub fn vstack<T: Borrow<Tensor>>(
        tensors: &[T]
    ) -> Tensor {
        Tensor::f_vstack(tensors).unwrap()
    }

    pub fn vstack_out<T: Borrow<Tensor>>(
        out: &Tensor, tensors: &[T]
    ) -> Tensor {
    ...
    pub fn where_self_out(
        &self, out: &Tensor, condition: &Tensor, other: &Tensor
    ) -> Tensor {
    ...
    pub fn xlogy_outtensor(
        &self, out: &Tensor, other: &Tensor
    ) -> Tensor {
        self.f_xlogy_outtensor(out, other).unwrap()
    }

    pub fn xlogy_scalar_other<S: Into<Scalar>>(
        &self, other: S
    ) -> Tensor {
        self.f_xlogy_scalar_other(other).unwrap()
    }

    pub fn xlogy_scalar_other_<S: Into<Scalar>>(
        &mut self, other: S
    ) -> Tensor {
